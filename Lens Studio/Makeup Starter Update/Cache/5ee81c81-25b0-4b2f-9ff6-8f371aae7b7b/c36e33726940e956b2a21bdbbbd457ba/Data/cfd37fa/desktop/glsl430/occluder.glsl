...
//sampler sampler z_hitIdAndBarycentricSmp 0:28
//sampler sampler z_rayDirectionsSmpSC 0:29
...
//texture utexture2D z_hitIdAndBarycentric 0:18:0:28
//texture texture2D z_rayDirections 0:19:0:29
//texture texture2DArray intensityTextureArrSC 0:30:0:20
//texture texture2DArray sc_ScreenTextureArrSC 0:33:0:25
...
uniform vec4 Port_FinalColor_N004;
...
{
if (Port_FinalColor_N004.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (Port_FinalColor_N004.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#if (sc_ProxyAlphaOne)
{
vec4 l9_2=Port_FinalColor_N004;
l9_2.w=1.0;
l9_1=l9_2;
}
#else
{
l9_1=Port_FinalColor_N004;
}
#endif
...
{
l9_5=clamp(Port_FinalColor_N004.w*2.0,0.0,1.0);
}
#else
{
float l9_6;
...
{
l9_6=clamp(dot(Port_FinalColor_N004.xyz,vec3(Port_FinalColor_N004.w)),0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_8=(1.0-dot(Port_FinalColor_N004.xyz,vec3(0.33333001)))*Port_FinalColor_N004.w;
}
#else
{
float l9_9;
...
{
l9_9=(1.0-clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0))*Port_FinalColor_N004.w;
}
#else
{
float l9_10;
...
{
l9_10=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0)*Port_FinalColor_N004.w;
}
#else
{
float l9_11;
#if (sc_BlendMode_Add)
{
l9_11=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_12;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_12=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0)*Port_FinalColor_N004.w;
}
#else
{
float l9_13;
...
{
l9_13=dot(Port_FinalColor_N004.xyz,vec3(0.33333001))*Port_FinalColor_N004.w;
}
#else
{
float l9_14;
#if (sc_BlendMode_Min)
{
l9_14=1.0-clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_15;
#if (sc_BlendMode_Max)
{
l9_15=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_15=1.0;
...
#endif
l9_3=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*Port_FinalColor_N004.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_4);
}
#else
{
vec4 l9_16;
...
{
l9_16=vec4(Port_FinalColor_N004.w);
}
#else
{
vec4 l9_17;
...
#else
{
vec2 l9_22=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_23;
...
{
l9_24=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_22,sc_ScreenTextureLayout,l9_23),0.0);
}
#else
{
l9_24=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_22,sc_ScreenTextureLayout,l9_23).xy,0.0);
}
#endif
l9_18=l9_24;
}
...
#endif
vec3 l9_27=mix(l9_25.xyz,definedBlend(l9_25.xyz,Port_FinalColor_N004.xyz).xyz,vec3(Port_FinalColor_N004.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),Port_FinalColor_N004.xyz,vec3(Port_FinalColor_N004.w)),Port_FinalColor_N004.w);
}
#else
{
vec4 l9_30;
...
{
l9_31=clamp(Port_FinalColor_N004.w,0.0,1.0);
}
#else
{
l9_31=Port_FinalColor_N004.w;
}
#endif
l9_30=vec4(Port_FinalColor_N004.xyz*l9_31,l9_31);
}
#else
{
l9_30=Port_FinalColor_N004;
}
#endif
l9_29=l9_30;
}
