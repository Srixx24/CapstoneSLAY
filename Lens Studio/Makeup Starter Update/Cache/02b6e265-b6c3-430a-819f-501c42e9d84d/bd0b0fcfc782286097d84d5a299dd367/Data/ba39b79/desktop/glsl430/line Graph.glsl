...
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 127
//spec_const bool sc_RenderAlphaToColor 128
//spec_const bool sc_SSAOEnabled 129
//spec_const bool sc_ScreenTextureHasSwappedViews 130
//spec_const bool sc_ShaderComplexityAnalyzer 131
//spec_const bool sc_TAAEnabled 132
//spec_const bool sc_UseFramebufferFetchMarker 133
//spec_const bool sc_VertexBlending 134
//spec_const bool sc_VertexBlendingUseNormals 135
//spec_const bool uv2EnableAnimation 136
//spec_const bool uv3EnableAnimation 137
//spec_const int NODE_13_DROPLIST_ITEM 138
//spec_const int NODE_181_DROPLIST_ITEM 139
//spec_const int NODE_184_DROPLIST_ITEM 140
//spec_const int NODE_221_DROPLIST_ITEM 141
//spec_const int NODE_228_DROPLIST_ITEM 142
//spec_const int NODE_27_DROPLIST_ITEM 143
//spec_const int NODE_315_DROPLIST_ITEM 144
//spec_const int NODE_38_DROPLIST_ITEM 145
//spec_const int NODE_49_DROPLIST_ITEM 146
//spec_const int NODE_69_DROPLIST_ITEM 147
//spec_const int NODE_76_DROPLIST_ITEM 148
//spec_const int SC_DEVICE_CLASS 149
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 150
//spec_const int SC_SOFTWARE_WRAP_MODE_U_detailNormalTex 151
//spec_const int SC_SOFTWARE_WRAP_MODE_U_emissiveTex 152
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 153
//spec_const int SC_SOFTWARE_WRAP_MODE_U_materialParamsTex 154
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 155
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 156
//spec_const int SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex 157
//spec_const int SC_SOFTWARE_WRAP_MODE_U_reflectionTex 158
//spec_const int SC_SOFTWARE_WRAP_MODE_U_rimColorTex 159
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 160
//spec_const int SC_SOFTWARE_WRAP_MODE_V_detailNormalTex 161
//spec_const int SC_SOFTWARE_WRAP_MODE_V_emissiveTex 162
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 163
//spec_const int SC_SOFTWARE_WRAP_MODE_V_materialParamsTex 164
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 165
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 166
//spec_const int SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex 167
//spec_const int SC_SOFTWARE_WRAP_MODE_V_reflectionTex 168
//spec_const int SC_SOFTWARE_WRAP_MODE_V_rimColorTex 169
//spec_const int baseTexLayout 170
//spec_const int detailNormalTexLayout 171
//spec_const int emissiveTexLayout 172
//spec_const int intensityTextureLayout 173
//spec_const int materialParamsTexLayout 174
//spec_const int normalTexLayout 175
//spec_const int opacityTexLayout 176
//spec_const int reflectionModulationTexLayout 177
//spec_const int reflectionTexLayout 178
//spec_const int rimColorTexLayout 179
//spec_const int sc_AmbientLightMode0 180
//spec_const int sc_AmbientLightMode1 181
//spec_const int sc_AmbientLightMode2 182
//spec_const int sc_AmbientLightMode_Constant 183
//spec_const int sc_AmbientLightMode_EnvironmentMap 184
//spec_const int sc_AmbientLightMode_FromCamera 185
//spec_const int sc_AmbientLightMode_SphericalHarmonics 186
//spec_const int sc_AmbientLightsCount 187
//spec_const int sc_DepthBufferMode 188
//spec_const int sc_DirectionalLightsCount 189
//spec_const int sc_EnvLightMode 190
//spec_const int sc_EnvmapDiffuseLayout 191
//spec_const int sc_EnvmapSpecularLayout 192
//spec_const int sc_LightEstimationSGCount 193
//spec_const int sc_MaxTextureImageUnits 194
//spec_const int sc_PointLightsCount 195
//spec_const int sc_RayTracedAoTextureLayout 196
//spec_const int sc_RayTracedDiffIndTextureLayout 197
//spec_const int sc_RayTracedShadowTextureLayout 198
//spec_const int sc_RenderingSpace 199
//spec_const int sc_ScreenTextureLayout 200
//spec_const int sc_ShaderCacheConstant 201
//spec_const int sc_SkinBonesCount 202
//spec_const int sc_StereoRenderingMode 203
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 204
//spec_const int sc_StereoViewID 205
//SG_REFLECTION_END
...
#endif
tempGlobals=ssGlobals(l9_1,l9_2,0.0,vec2(0.0),vec2(0.0),vec3(0.0),normalize(sc_Camera.position-varPos),varPos,l9_3,l9_4,cross(l9_3,l9_4)*varTangent.w,varPackedTex.xy,varPackedTex.zw,varColor,l9_6,varPos);
...
#if (ENABLE_BASE_TEX)
{
vec2 l9_9=N7_getUV(NODE_27_DROPLIST_ITEM);
vec4 l9_10;
#if (baseTexLayout==2)
{
float l9_11=l9_9.x;
...
float l9_26=l9_25.x;
float l9_27=l9_16;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_27);
float l9_28=l9_25.y;
float l9_29=l9_27;
sc_SoftwareWrapLate(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_29);
float l9_30=l9_29;
...
float l9_49=l9_48.x;
float l9_50=l9_39;
sc_SoftwareWrapLate(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_50);
float l9_51=l9_48.y;
float l9_52=l9_50;
sc_SoftwareWrapLate(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_52);
float l9_53=l9_52;
...
#if (ENABLE_RECOLOR)
{
l9_57=vec4(vec3(0.0).x,vec3(0.0).y,vec3(0.0).z,l9_8.w);
}
#else
{
l9_57=l9_8;
...
float l9_76=l9_75.x;
float l9_77=l9_66;
sc_SoftwareWrapLate(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_77);
float l9_78=l9_75.y;
float l9_79=l9_77;
sc_SoftwareWrapLate(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_79);
float l9_80=l9_79;
...
float l9_99=l9_98.x;
float l9_100=l9_89;
sc_SoftwareWrapLate(l9_99,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_100);
float l9_101=l9_98.y;
float l9_102=l9_100;
sc_SoftwareWrapLate(l9_101,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_102);
float l9_103=l9_102;
vec3 l9_104=sc_SamplingCoordsViewToGlobal(vec2(l9_99,l9_101),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_105=texture(opacityTex,l9_104.xy,0.0);
vec4 l9_106;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#endif
float l9_107=l9_58*l9_57.w;
float l9_108;
#if (NODE_38_DROPLIST_ITEM==1)
{
l9_108=l9_107*tempGlobals.VertexColor.w;
}
#else
{
l9_108=l9_107;
...
#if (ENABLE_NORMALMAP)
{
vec2 l9_110=N7_getUV(NODE_181_DROPLIST_ITEM);
vec4 l9_111;
#if (normalTexLayout==2)
{
float l9_112=l9_110.x;
sc_SoftwareWrapEarly(l9_112,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_113=l9_112;
float l9_114=l9_110.y;
sc_SoftwareWrapEarly(l9_114,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_115=l9_114;
vec2 l9_116;
float l9_117;
...
{
l9_118=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_118=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_119=l9_113;
float l9_120=1.0;
sc_ClampUV(l9_119,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_118,l9_120);
float l9_121=l9_119;
float l9_122=l9_120;
bool l9_123;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_123=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_123=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_124=l9_115;
float l9_125=l9_122;
sc_ClampUV(l9_124,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_123,l9_125);
l9_117=l9_125;
...
#endif
vec2 l9_126=sc_TransformUV(l9_116,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_127=l9_126.x;
float l9_128=l9_117;
sc_SoftwareWrapLate(l9_127,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_128);
float l9_129=l9_126.y;
float l9_130=l9_128;
sc_SoftwareWrapLate(l9_129,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_130);
float l9_131=l9_130;
vec3 l9_132=sc_SamplingCoordsViewToGlobal(vec2(l9_127,l9_129),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_133=texture(normalTexArrSC,l9_132,0.0);
vec4 l9_134;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_134=mix(normalTexBorderColor,l9_133,vec4(l9_131));
}
#else
{
l9_134=l9_133;
...
#else
{
float l9_135=l9_110.x;
sc_SoftwareWrapEarly(l9_135,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_136=l9_135;
float l9_137=l9_110.y;
sc_SoftwareWrapEarly(l9_137,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_138=l9_137;
vec2 l9_139;
float l9_140;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_141=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_141=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_142=l9_136;
float l9_143=1.0;
sc_ClampUV(l9_142,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_141,l9_143);
float l9_144=l9_142;
float l9_145=l9_143;
bool l9_146;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_146=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
...
float l9_147=l9_138;
float l9_148=l9_145;
sc_ClampUV(l9_147,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_146,l9_148);
l9_140=l9_148;
...
#endif
vec2 l9_149=sc_TransformUV(l9_139,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_150=l9_149.x;
float l9_151=l9_140;
sc_SoftwareWrapLate(l9_150,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_151);
float l9_152=l9_149.y;
float l9_153=l9_151;
sc_SoftwareWrapLate(l9_152,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_153);
float l9_154=l9_153;
vec3 l9_155=sc_SamplingCoordsViewToGlobal(vec2(l9_150,l9_152),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_156=texture(normalTex,l9_155.xy,0.0);
vec4 l9_157;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_157=mix(normalTexBorderColor,l9_156,vec4(l9_154));
}
#else
{
l9_157=l9_156;
...
{
vec2 l9_159=N7_getUV(NODE_184_DROPLIST_ITEM);
vec4 l9_160;
#if (detailNormalTexLayout==2)
{
float l9_161=l9_159.x;
sc_SoftwareWrapEarly(l9_161,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_162=l9_161;
float l9_163=l9_159.y;
sc_SoftwareWrapEarly(l9_163,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_164=l9_163;
vec2 l9_165;
float l9_166;
...
{
l9_167=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_167=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_168=l9_162;
float l9_169=1.0;
sc_ClampUV(l9_168,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_167,l9_169);
float l9_170=l9_168;
float l9_171=l9_169;
bool l9_172;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_172=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
...
float l9_173=l9_164;
float l9_174=l9_171;
sc_ClampUV(l9_173,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_172,l9_174);
l9_166=l9_174;
...
#endif
vec2 l9_175=sc_TransformUV(l9_165,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_176=l9_175.x;
float l9_177=l9_166;
sc_SoftwareWrapLate(l9_176,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_177);
float l9_178=l9_175.y;
float l9_179=l9_177;
sc_SoftwareWrapLate(l9_178,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_179);
float l9_180=l9_179;
vec3 l9_181=sc_SamplingCoordsViewToGlobal(vec2(l9_176,l9_178),detailNormalTexLayout,detailNormalTexGetStereoViewIndex());
vec4 l9_182=texture(detailNormalTexArrSC,l9_181,0.0);
vec4 l9_183;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_183=mix(detailNormalTexBorderColor,l9_182,vec4(l9_180));
}
#else
{
l9_183=l9_182;
...
#else
{
float l9_184=l9_159.x;
sc_SoftwareWrapEarly(l9_184,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_185=l9_184;
float l9_186=l9_159.y;
sc_SoftwareWrapEarly(l9_186,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_187=l9_186;
vec2 l9_188;
float l9_189;
#if (SC_USE_UV_MIN_MAX_detailNormalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_190=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
...
float l9_191=l9_185;
float l9_192=1.0;
sc_ClampUV(l9_191,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_190,l9_192);
float l9_193=l9_191;
float l9_194=l9_192;
bool l9_195;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_195=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
...
float l9_196=l9_187;
float l9_197=l9_194;
sc_ClampUV(l9_196,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_195,l9_197);
l9_189=l9_197;
...
#endif
vec2 l9_198=sc_TransformUV(l9_188,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_199=l9_198.x;
float l9_200=l9_189;
sc_SoftwareWrapLate(l9_199,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_200);
float l9_201=l9_198.y;
float l9_202=l9_200;
sc_SoftwareWrapLate(l9_201,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_202);
float l9_203=l9_202;
vec3 l9_204=sc_SamplingCoordsViewToGlobal(vec2(l9_199,l9_201),detailNormalTexLayout,detailNormalTexGetStereoViewIndex());
vec4 l9_205=texture(detailNormalTex,l9_204.xy,0.0);
vec4 l9_206;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_206=mix(detailNormalTexBorderColor,l9_205,vec4(l9_203));
}
#else
{
l9_206=l9_205;
...
#endif
l9_158=(l9_160.xyz*1.9921875)-vec3(1.0);
}
#else
{
l9_158=vec3(0.0,0.0,1.0);
}
#endif
vec3 l9_207=((l9_111.xyz*1.9921875)-vec3(1.0))+vec3(0.0,0.0,1.0);
vec3 l9_208=l9_158*vec3(-1.0,-1.0,1.0);
l9_109=normalize(mat3(tempGlobals.VertexTangent_WorldSpace,tempGlobals.VertexBinormal_WorldSpace,tempGlobals.VertexNormal_WorldSpace)*normalize((l9_207*dot(l9_207,l9_208))-(l9_208*l9_207.z)));
}
#else
{
l9_109=normalize(tempGlobals.VertexNormal_WorldSpace);
}
#endif
vec3 l9_209;
#if (ENABLE_EMISSIVE)
{
vec2 l9_210=N7_getUV(NODE_76_DROPLIST_ITEM);
vec4 l9_211;
#if (emissiveTexLayout==2)
{
float l9_212=l9_210.x;
sc_SoftwareWrapEarly(l9_212,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x);
float l9_213=l9_212;
float l9_214=l9_210.y;
sc_SoftwareWrapEarly(l9_214,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y);
float l9_215=l9_214;
vec2 l9_216;
float l9_217;
...
{
l9_218=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x==3;
}
#else
{
l9_218=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_219=l9_213;
float l9_220=1.0;
sc_ClampUV(l9_219,emissiveTexUvMinMax.x,emissiveTexUvMinMax.z,l9_218,l9_220);
float l9_221=l9_219;
float l9_222=l9_220;
bool l9_223;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_223=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y==3;
}
#else
{
l9_223=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_224=l9_215;
float l9_225=l9_222;
sc_ClampUV(l9_224,emissiveTexUvMinMax.y,emissiveTexUvMinMax.w,l9_223,l9_225);
l9_217=l9_225;
l9_216=vec2(l9_221,l9_224);
}
#else
{
l9_217=1.0;
l9_216=vec2(l9_213,l9_215);
}
#endif
vec2 l9_226=sc_TransformUV(l9_216,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform);
float l9_227=l9_226.x;
float l9_228=l9_217;
sc_SoftwareWrapLate(l9_227,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0)),l9_228);
float l9_229=l9_226.y;
float l9_230=l9_228;
sc_SoftwareWrapLate(l9_229,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0)),l9_230);
float l9_231=l9_230;
vec3 l9_232=sc_SamplingCoordsViewToGlobal(vec2(l9_227,l9_229),emissiveTexLayout,emissiveTexGetStereoViewIndex());
vec4 l9_233=texture(emissiveTexArrSC,l9_232,0.0);
vec4 l9_234;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_234=mix(emissiveTexBorderColor,l9_233,vec4(l9_231));
}
#else
{
l9_234=l9_233;
...
#else
{
float l9_235=l9_210.x;
sc_SoftwareWrapEarly(l9_235,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x);
float l9_236=l9_235;
float l9_237=l9_210.y;
sc_SoftwareWrapEarly(l9_237,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y);
float l9_238=l9_237;
vec2 l9_239;
float l9_240;
#if (SC_USE_UV_MIN_MAX_emissiveTex)
...
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_241=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x==3;
}
#else
{
l9_241=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_242=l9_236;
float l9_243=1.0;
sc_ClampUV(l9_242,emissiveTexUvMinMax.x,emissiveTexUvMinMax.z,l9_241,l9_243);
float l9_244=l9_242;
float l9_245=l9_243;
bool l9_246;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_246=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y==3;
}
#else
{
l9_246=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_247=l9_238;
float l9_248=l9_245;
sc_ClampUV(l9_247,emissiveTexUvMinMax.y,emissiveTexUvMinMax.w,l9_246,l9_248);
l9_240=l9_248;
l9_239=vec2(l9_244,l9_247);
}
#else
{
l9_240=1.0;
l9_239=vec2(l9_236,l9_238);
}
#endif
vec2 l9_249=sc_TransformUV(l9_239,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform);
float l9_250=l9_249.x;
float l9_251=l9_240;
sc_SoftwareWrapLate(l9_250,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0)),l9_251);
float l9_252=l9_249.y;
float l9_253=l9_251;
sc_SoftwareWrapLate(l9_252,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0)),l9_253);
float l9_254=l9_253;
vec3 l9_255=sc_SamplingCoordsViewToGlobal(vec2(l9_250,l9_252),emissiveTexLayout,emissiveTexGetStereoViewIndex());
vec4 l9_256=texture(emissiveTex,l9_255.xy,0.0);
vec4 l9_257;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_257=mix(emissiveTexBorderColor,l9_256,vec4(l9_254));
}
#else
{
l9_257=l9_256;
...
{
l9_258=l9_209+tempGlobals.VertexColor.xyz;
}
#else
{
l9_258=l9_209;
...
{
l9_259=ssPow((l9_258*emissiveColor)*vec3(emissiveIntensity),vec3(2.2));
}
#else
{
l9_259=l9_258;
...
{
vec3 l9_261=tempGlobals.ViewDirWS;
vec3 l9_262=reflect(l9_261,l9_109);
float l9_263=l9_262.x;
float l9_264=l9_262.y;
float l9_265=(-l9_262.z)+1.0;
float l9_266=((l9_263*l9_263)+(l9_264*l9_264))+(l9_265*l9_265);
float l9_267;
if (l9_266<=0.0)
{
l9_267=0.0;
...
float l9_268=2.0*l9_267;
vec2 l9_269=vec2(1.0)-((l9_262.xy/vec2(l9_268))+vec2(0.5));
vec4 l9_270;
#if (reflectionTexLayout==2)
{
float l9_271=l9_269.x;
sc_SoftwareWrapEarly(l9_271,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x);
float l9_272=l9_271;
float l9_273=l9_269.y;
sc_SoftwareWrapEarly(l9_273,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y);
float l9_274=l9_273;
vec2 l9_275;
float l9_276;
...
{
l9_277=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x==3;
}
#else
{
l9_277=(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0);
}
#endif
float l9_278=l9_272;
float l9_279=1.0;
sc_ClampUV(l9_278,reflectionTexUvMinMax.x,reflectionTexUvMinMax.z,l9_277,l9_279);
float l9_280=l9_278;
float l9_281=l9_279;
bool l9_282;
#if (SC_USE_CLAMP_TO_BORDER_reflectionTex)
{
l9_282=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y==3;
}
#else
{
l9_282=(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0);
}
#endif
float l9_283=l9_274;
float l9_284=l9_281;
sc_ClampUV(l9_283,reflectionTexUvMinMax.y,reflectionTexUvMinMax.w,l9_282,l9_284);
l9_276=l9_284;
...
#endif
vec2 l9_285=sc_TransformUV(l9_275,(int(SC_USE_UV_TRANSFORM_reflectionTex)!=0),reflectionTexTransform);
float l9_286=l9_285.x;
float l9_287=l9_276;
sc_SoftwareWrapLate(l9_286,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0)),l9_287);
float l9_288=l9_285.y;
float l9_289=l9_287;
sc_SoftwareWrapLate(l9_288,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0)),l9_289);
float l9_290=l9_289;
vec3 l9_291=sc_SamplingCoordsViewToGlobal(vec2(l9_286,l9_288),reflectionTexLayout,reflectionTexGetStereoViewIndex());
vec4 l9_292=texture(reflectionTexArrSC,l9_291,0.0);
vec4 l9_293;
#if (SC_USE_CLAMP_TO_BORDER_reflectionTex)
{
l9_293=mix(reflectionTexBorderColor,l9_292,vec4(l9_290));
}
#else
{
l9_293=l9_292;
...
float l9_310=l9_299;
sc_SoftwareWrapLate(l9_309,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0)),l9_310);
float l9_311=l9_308.y;
float l9_312=l9_310;
sc_SoftwareWrapLate(l9_311,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0)),l9_312);
float l9_313=l9_312;
vec3 l9_314=sc_SamplingCoordsViewToGlobal(vec2(l9_309,l9_311),reflectionTexLayout,reflectionTexGetStereoViewIndex());
vec4 l9_315=texture(reflectionTex,l9_314.xy,0.0);
vec4 l9_316;
#if (SC_USE_CLAMP_TO_BORDER_reflectionTex)
{
...
#if (Tweak_N177)
{
vec2 l9_318=N7_getUV(NODE_228_DROPLIST_ITEM);
vec4 l9_319;
#if (reflectionModulationTexLayout==2)
{
float l9_320=l9_318.x;
sc_SoftwareWrapEarly(l9_320,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x);
float l9_321=l9_320;
float l9_322=l9_318.y;
sc_SoftwareWrapEarly(l9_322,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y);
float l9_323=l9_322;
vec2 l9_324;
float l9_325;
...
{
l9_326=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x==3;
}
#else
{
l9_326=(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0);
}
#endif
float l9_327=l9_321;
float l9_328=1.0;
sc_ClampUV(l9_327,reflectionModulationTexUvMinMax.x,reflectionModulationTexUvMinMax.z,l9_326,l9_328);
float l9_329=l9_327;
float l9_330=l9_328;
bool l9_331;
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_331=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y==3;
}
#else
{
l9_331=(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0);
}
#endif
float l9_332=l9_323;
float l9_333=l9_330;
sc_ClampUV(l9_332,reflectionModulationTexUvMinMax.y,reflectionModulationTexUvMinMax.w,l9_331,l9_333);
l9_325=l9_333;
...
#endif
vec2 l9_334=sc_TransformUV(l9_324,(int(SC_USE_UV_TRANSFORM_reflectionModulationTex)!=0),reflectionModulationTexTransform);
float l9_335=l9_334.x;
float l9_336=l9_325;
sc_SoftwareWrapLate(l9_335,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x,(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0)),l9_336);
float l9_337=l9_334.y;
float l9_338=l9_336;
sc_SoftwareWrapLate(l9_337,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y,(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0)),l9_338);
float l9_339=l9_338;
vec3 l9_340=sc_SamplingCoordsViewToGlobal(vec2(l9_335,l9_337),reflectionModulationTexLayout,reflectionModulationTexGetStereoViewIndex());
vec4 l9_341=texture(reflectionModulationTexArrSC,l9_340,0.0);
vec4 l9_342;
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_342=mix(reflectionModulationTexBorderColor,l9_341,vec4(l9_339));
}
#else
{
l9_342=l9_341;
...
#else
{
float l9_343=l9_318.x;
sc_SoftwareWrapEarly(l9_343,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x);
float l9_344=l9_343;
float l9_345=l9_318.y;
sc_SoftwareWrapEarly(l9_345,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y);
float l9_346=l9_345;
vec2 l9_347;
float l9_348;
#if (SC_USE_UV_MIN_MAX_reflectionModulationTex)
...
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_349=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x==3;
}
#else
{
l9_349=(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0);
}
#endif
float l9_350=l9_344;
float l9_351=1.0;
sc_ClampUV(l9_350,reflectionModulationTexUvMinMax.x,reflectionModulationTexUvMinMax.z,l9_349,l9_351);
float l9_352=l9_350;
float l9_353=l9_351;
bool l9_354;
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_354=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y==3;
}
#else
{
l9_354=(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0);
}
#endif
float l9_355=l9_346;
float l9_356=l9_353;
sc_ClampUV(l9_355,reflectionModulationTexUvMinMax.y,reflectionModulationTexUvMinMax.w,l9_354,l9_356);
l9_348=l9_356;
l9_347=vec2(l9_352,l9_355);
}
#else
{
l9_348=1.0;
l9_347=vec2(l9_344,l9_346);
}
#endif
vec2 l9_357=sc_TransformUV(l9_347,(int(SC_USE_UV_TRANSFORM_reflectionModulationTex)!=0),reflectionModulationTexTransform);
float l9_358=l9_357.x;
float l9_359=l9_348;
sc_SoftwareWrapLate(l9_358,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x,(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0)),l9_359);
float l9_360=l9_357.y;
float l9_361=l9_359;
sc_SoftwareWrapLate(l9_360,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y,(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0)),l9_361);
float l9_362=l9_361;
vec3 l9_363=sc_SamplingCoordsViewToGlobal(vec2(l9_358,l9_360),reflectionModulationTexLayout,reflectionModulationTexGetStereoViewIndex());
vec4 l9_364=texture(reflectionModulationTex,l9_363.xy,0.0);
vec4 l9_365;
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_365=mix(reflectionModulationTexBorderColor,l9_364,vec4(l9_362));
}
#else
{
l9_365=l9_364;
...
#endif
l9_260=ssSRGB_to_Linear(l9_317)*reflectionIntensity;
}
#else
{
l9_260=vec3(0.0);
...
{
vec3 l9_367=rimColor*rimIntensity;
vec3 l9_368;
#if (Tweak_N216)
{
vec2 l9_369=N7_getUV(NODE_315_DROPLIST_ITEM);
vec4 l9_370;
#if (rimColorTexLayout==2)
{
float l9_371=l9_369.x;
sc_SoftwareWrapEarly(l9_371,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x);
float l9_372=l9_371;
float l9_373=l9_369.y;
sc_SoftwareWrapEarly(l9_373,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y);
float l9_374=l9_373;
vec2 l9_375;
float l9_376;
...
{
l9_377=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x==3;
}
#else
{
l9_377=(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0);
}
#endif
float l9_378=l9_372;
float l9_379=1.0;
sc_ClampUV(l9_378,rimColorTexUvMinMax.x,rimColorTexUvMinMax.z,l9_377,l9_379);
float l9_380=l9_378;
float l9_381=l9_379;
bool l9_382;
#if (SC_USE_CLAMP_TO_BORDER_rimColorTex)
{
l9_382=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y==3;
}
#else
{
l9_382=(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0);
}
#endif
float l9_383=l9_374;
float l9_384=l9_381;
sc_ClampUV(l9_383,rimColorTexUvMinMax.y,rimColorTexUvMinMax.w,l9_382,l9_384);
l9_376=l9_384;
...
#endif
vec2 l9_385=sc_TransformUV(l9_375,(int(SC_USE_UV_TRANSFORM_rimColorTex)!=0),rimColorTexTransform);
float l9_386=l9_385.x;
float l9_387=l9_376;
sc_SoftwareWrapLate(l9_386,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x,(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0)),l9_387);
float l9_388=l9_385.y;
float l9_389=l9_387;
sc_SoftwareWrapLate(l9_388,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y,(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0)),l9_389);
float l9_390=l9_389;
vec3 l9_391=sc_SamplingCoordsViewToGlobal(vec2(l9_386,l9_388),rimColorTexLayout,rimColorTexGetStereoViewIndex());
vec4 l9_392=texture(rimColorTexArrSC,l9_391,0.0);
vec4 l9_393;
#if (SC_USE_CLAMP_TO_BORDER_rimColorTex)
{
l9_393=mix(rimColorTexBorderColor,l9_392,vec4(l9_390));
}
#else
{
l9_393=l9_392;
...
#else
{
float l9_394=l9_369.x;
sc_SoftwareWrapEarly(l9_394,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x);
float l9_395=l9_394;
float l9_396=l9_369.y;
sc_SoftwareWrapEarly(l9_396,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y);
float l9_397=l9_396;
vec2 l9_398;
float l9_399;
#if (SC_USE_UV_MIN_MAX_rimColorTex)
...
#if (SC_USE_CLAMP_TO_BORDER_rimColorTex)
{
l9_400=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x==3;
}
#else
{
l9_400=(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0);
}
#endif
float l9_401=l9_395;
float l9_402=1.0;
sc_ClampUV(l9_401,rimColorTexUvMinMax.x,rimColorTexUvMinMax.z,l9_400,l9_402);
float l9_403=l9_401;
float l9_404=l9_402;
bool l9_405;
#if (SC_USE_CLAMP_TO_BORDER_rimColorTex)
{
l9_405=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y==3;
}
#else
{
...
float l9_406=l9_397;
float l9_407=l9_404;
sc_ClampUV(l9_406,rimColorTexUvMinMax.y,rimColorTexUvMinMax.w,l9_405,l9_407);
l9_399=l9_407;
l9_398=vec2(l9_403,l9_406);
}
#else
{
l9_399=1.0;
l9_398=vec2(l9_395,l9_397);
}
#endif
vec2 l9_408=sc_TransformUV(l9_398,(int(SC_USE_UV_TRANSFORM_rimColorTex)!=0),rimColorTexTransform);
float l9_409=l9_408.x;
float l9_410=l9_399;
sc_SoftwareWrapLate(l9_409,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x,(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0)),l9_410);
float l9_411=l9_408.y;
float l9_412=l9_410;
sc_SoftwareWrapLate(l9_411,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y,(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0)),l9_412);
float l9_413=l9_412;
vec3 l9_414=sc_SamplingCoordsViewToGlobal(vec2(l9_409,l9_411),rimColorTexLayout,rimColorTexGetStereoViewIndex());
vec4 l9_415=texture(rimColorTex,l9_414.xy,0.0);
vec4 l9_416;
#if (SC_USE_CLAMP_TO_BORDER_rimColorTex)
{
l9_416=mix(rimColorTexBorderColor,l9_415,vec4(l9_413));
}
#else
{
l9_416=l9_415;
...
#endif
vec3 l9_417=tempGlobals.ViewDirWS;
float l9_418=dot(l9_109,l9_417);
float l9_419=abs(l9_418);
float l9_420;
...
{
l9_421=pow(l9_420,rimExponent);
}
l9_366=vec3(0.0)+(ssSRGB_to_Linear(l9_368)*l9_421);
}
#else
{
l9_366=vec3(0.0);
...
sc_SoftwareWrapEarly(l9_423,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_424=l9_423;
float l9_425=l9_422.y;
sc_SoftwareWrapEarly(l9_425,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_426=l9_425;
vec2 l9_427;
float l9_428;
...
{
l9_429=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_429=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_430=l9_424;
float l9_431=1.0;
sc_ClampUV(l9_430,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_429,l9_431);
float l9_432=l9_430;
float l9_433=l9_431;
bool l9_434;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_434=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_434=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_435=l9_426;
float l9_436=l9_433;
sc_ClampUV(l9_435,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_434,l9_436);
l9_428=l9_436;
...
#endif
vec2 l9_437=sc_TransformUV(l9_427,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_438=l9_437.x;
float l9_439=l9_428;
sc_SoftwareWrapLate(l9_438,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_439);
float l9_440=l9_437.y;
float l9_441=l9_439;
sc_SoftwareWrapLate(l9_440,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_441);
}
#else
{
float l9_442=l9_422.x;
sc_SoftwareWrapEarly(l9_442,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_443=l9_442;
float l9_444=l9_422.y;
sc_SoftwareWrapEarly(l9_444,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_445=l9_444;
vec2 l9_446;
float l9_447;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_448=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_448=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_449=l9_443;
float l9_450=1.0;
sc_ClampUV(l9_449,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_448,l9_450);
float l9_451=l9_449;
float l9_452=l9_450;
bool l9_453;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_453=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_454=l9_445;
float l9_455=l9_452;
sc_ClampUV(l9_454,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_453,l9_455);
l9_447=l9_455;
l9_446=vec2(l9_451,l9_454);
}
#else
{
l9_447=1.0;
l9_446=vec2(l9_443,l9_445);
}
#endif
vec2 l9_456=sc_TransformUV(l9_446,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_457=l9_456.x;
float l9_458=l9_447;
sc_SoftwareWrapLate(l9_457,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_458);
float l9_459=l9_456.y;
float l9_460=l9_458;
sc_SoftwareWrapLate(l9_459,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_460);
}
#endif
}
#endif
float l9_461=clamp(l9_108,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_461<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_461<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
l9_274=ssSRGB_to_Linear(l9_331)*reflectionIntensity;
}
#else
{
l9_274=vec3(0.0);
...
l9_380=vec3(0.0)+(ssSRGB_to_Linear(l9_382)*l9_435);
}
#else
{
l9_380=vec3(0.0);
...
#endif
vec3 l9_436=ssPow((l9_273+l9_274)+l9_380,vec3(0.45454547));
vec3 l9_437;
#if (NODE_38_DROPLIST_ITEM==3)
{
l9_437=tempGlobals.VertexColor.xyz;
}
#else
{
l9_437=vec3(1.0);
...
float l9_457=l9_446;
sc_SoftwareWrapLate(l9_456,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_457);
float l9_458=l9_455.y;
float l9_459=l9_457;
sc_SoftwareWrapLate(l9_458,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_459);
float l9_460=l9_459;
...
float l9_480=l9_469;
sc_SoftwareWrapLate(l9_479,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_480);
float l9_481=l9_478.y;
float l9_482=l9_480;
sc_SoftwareWrapLate(l9_481,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_482);
float l9_483=l9_482;
...
#endif
float l9_488=clamp(l9_122,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_489=max(l9_121.xyz,vec3(0.0));
vec4 l9_490;
#if (sc_ProjectiveShadowsCaster)
{
l9_490=vec4(l9_489,l9_488);
}
#else
{
l9_490=ngsCalculateLighting(l9_489,l9_488,l9_487,l9_10,l9_11,max(l9_436,vec3(0.0)),0.0,1.0,clamp(l9_438,vec3(0.0),vec3(1.0)),vec3(1.0));
}
#endif
vec4 l9_491=max(l9_490,vec4(0.0));
if (isProxyMode)
{
vec4 l9_492;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_492,vec4(0.0)));
return;
}
vec4 l9_494;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_496=clamp(l9_491.w*2.0,0.0,1.0);
}
#else
{
float l9_497;
...
{
l9_497=clamp(dot(l9_491.xyz,vec3(l9_491.w)),0.0,1.0);
}
#else
{
float l9_498;
...
#if (sc_BlendMode_Multiply)
{
l9_499=(1.0-dot(l9_491.xyz,vec3(0.33333001)))*l9_491.w;
}
#else
{
float l9_500;
...
{
l9_500=(1.0-clamp(dot(l9_491.xyz,vec3(1.0)),0.0,1.0))*l9_491.w;
}
#else
{
float l9_501;
#if (sc_BlendMode_ColoredGlass)
{
l9_501=clamp(dot(l9_491.xyz,vec3(1.0)),0.0,1.0)*l9_491.w;
}
#else
{
float l9_502;
#if (sc_BlendMode_Add)
{
l9_502=clamp(dot(l9_491.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_503;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_503=clamp(dot(l9_491.xyz,vec3(1.0)),0.0,1.0)*l9_491.w;
}
#else
{
float l9_504;
...
{
l9_504=dot(l9_491.xyz,vec3(0.33333001))*l9_491.w;
}
#else
{
float l9_505;
#if (sc_BlendMode_Min)
{
l9_505=1.0-clamp(dot(l9_491.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_506;
#if (sc_BlendMode_Max)
{
l9_506=clamp(dot(l9_491.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_506=1.0;
...
#endif
l9_494=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_491.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_495);
}
#else
{
vec4 l9_507;
...
{
vec3 l9_509=sc_GetFramebufferColor().xyz;
vec3 l9_510=mix(l9_509,definedBlend(l9_509,l9_491.xyz).xyz,vec3(l9_491.w));
vec4 l9_511=vec4(l9_510.x,l9_510.y,l9_510.z,vec4(0.0).w);
l9_511.w=1.0;
l9_508=l9_511;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_513=l9_491.w;
l9_512=vec4(mix(vec3(1.0),l9_491.xyz,vec3(l9_513)),l9_513);
}
#else
{
vec4 l9_514;
...
{
float l9_515=l9_491.w;
float l9_516;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_516=clamp(l9_515,0.0,1.0);
}
#else
{
l9_516=l9_515;
...
#endif
l9_514=vec4(l9_491.xyz*l9_516,l9_516);
}
#else
{
l9_514=l9_491;
...
{
l9_519=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_519=vec4(0.0);
...
vec4 l9_521=outputMotionVectorsIfNeeded(varPos,max(l9_520,vec4(0.0)));
vec4 l9_522=clamp(l9_521,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_523=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_523-0.0039215689)),min(1.0,l9_523+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_524=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_524).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_525=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_524).xy);
float l9_526=packValue(l9_525);
int l9_533=int(l9_522.w*255.0);
float l9_534=packValue(l9_533);
sc_writeFragData0(vec4(packValue(l9_525),packValue(l9_525),packValue(l9_525),packValue(l9_525)));
sc_writeFragData1(vec4(l9_526,packValue(l9_525),packValue(l9_525),packValue(l9_525)));
sc_writeFragData2(vec4(l9_534,packValue(l9_533),packValue(l9_533),packValue(l9_533)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_537=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_537).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_542==0)
{
l9_545=texture(sc_OITAlpha0,l9_537);
l9_544=texture(sc_OITDepthLow0,l9_537);
l9_543=texture(sc_OITDepthHigh0,l9_537);
}
else
{
l9_545=vec4(0.0);
...
if (l9_542==1)
{
l9_548=texture(sc_OITAlpha1,l9_537);
l9_547=texture(sc_OITDepthLow1,l9_537);
l9_546=texture(sc_OITDepthHigh1,l9_537);
}
else
{
l9_548=l9_545;
...
if (any(notEqual(l9_546,vec4(0.0)))||any(notEqual(l9_547,vec4(0.0))))
{
int l9_549[8]=l9_538;
unpackValues(l9_546.w,l9_542,l9_549);
unpackValues(l9_546.z,l9_542,l9_549);
unpackValues(l9_546.y,l9_542,l9_549);
unpackValues(l9_546.x,l9_542,l9_549);
unpackValues(l9_547.w,l9_542,l9_549);
unpackValues(l9_547.z,l9_542,l9_549);
unpackValues(l9_547.y,l9_542,l9_549);
unpackValues(l9_547.x,l9_542,l9_549);
int l9_558[8]=l9_539;
unpackValues(l9_548.w,l9_542,l9_558);
unpackValues(l9_548.z,l9_542,l9_558);
unpackValues(l9_548.y,l9_542,l9_558);
unpackValues(l9_548.x,l9_542,l9_558);
}
l9_542++;
continue;
}
...
vec4 l9_563=texture(sc_OITFilteredDepthBoundsTexture,l9_537);
vec2 l9_564=l9_563.xy;
int l9_565;
#if (sc_SkinBonesCount>0)
{
l9_565=encodeDepth(((1.0-l9_563.x)*1000.0)+getDepthOrderingEpsilon(),l9_564);
}
#else
{
l9_565=0;
...
#endif
int l9_566=encodeDepth(viewSpaceDepth(),l9_564);
vec4 l9_567;
l9_567=l9_522*l9_522.w;
vec4 l9_568;
int l9_569=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_569<8)
{
int l9_570=l9_538[l9_569];
int l9_571=l9_566-l9_565;
bool l9_572=l9_570<l9_571;
bool l9_573;
if (l9_572)
{
l9_573=l9_538[l9_569]>0;
}
else
{
l9_573=l9_572;
...
if (l9_573)
{
vec3 l9_574=l9_567.xyz*(1.0-(float(l9_539[l9_569])/255.0));
l9_568=vec4(l9_574.x,l9_574.y,l9_574.z,l9_567.w);
}
else
{
l9_568=l9_567;
...
sc_writeFragData0(l9_522);
}
#endif
}
#else
{
sc_writeFragData0(l9_521);
}
#endif
}
#endif
