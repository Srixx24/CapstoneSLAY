...
//sampler sampler maskTexSmpSC 0:19
...
//texture texture2D maskTex 0:2:0:19
...
//spec_const bool ENABLE_FACE_TEX 31
//spec_const bool ENABLE_SMOOTH_EDGES 32
//spec_const bool ENABLE_STIPPLE_PATTERN_TEST 33
//spec_const bool SC_DISABLE_FRUSTUM_CULLING 34
//spec_const bool SC_GL_FRAGMENT_PRECISION_HIGH 35
//spec_const bool SC_USE_CLAMP_TO_BORDER_baseTex 36
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 37
//spec_const bool SC_USE_CLAMP_TO_BORDER_maskTex 38
//spec_const bool SC_USE_UV_MIN_MAX_baseTex 39
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 40
//spec_const bool SC_USE_UV_MIN_MAX_maskTex 41
//spec_const bool SC_USE_UV_TRANSFORM_baseTex 42
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 43
//spec_const bool SC_USE_UV_TRANSFORM_maskTex 44
...
//spec_const bool maskTexHasSwappedViews 48
//spec_const bool sc_BlendMode_Add 49
//spec_const bool sc_BlendMode_AddWithAlphaFactor 50
...
//spec_const bool sc_BlendMode_MultiplyOriginal 58
//spec_const bool sc_BlendMode_Normal 59
//spec_const bool sc_BlendMode_PremultipliedAlpha 60
//spec_const bool sc_BlendMode_PremultipliedAlphaAuto 61
//spec_const bool sc_BlendMode_PremultipliedAlphaHardware 62
//spec_const bool sc_BlendMode_Screen 63
//spec_const bool sc_BlendMode_Software 64
//spec_const bool sc_CanUseStandardDerivatives 65
//spec_const bool sc_CanUseTextureLod 66
//spec_const bool sc_DepthOnly 67
//spec_const bool sc_EnvmapDiffuseHasSwappedViews 68
//spec_const bool sc_EnvmapSpecularHasSwappedViews 69
//spec_const bool sc_FramebufferFetch 70
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 71
//spec_const bool sc_HasDiffuseEnvmap 72
//spec_const bool sc_IsEditor 73
//spec_const bool sc_LightEstimation 74
//spec_const bool sc_MotionVectorsPass 75
//spec_const bool sc_OITCompositingPass 76
//spec_const bool sc_OITDepthBoundsPass 77
//spec_const bool sc_OITDepthGatherPass 78
//spec_const bool sc_OITDepthPrepass 79
//spec_const bool sc_OITFrontLayerPass 80
//spec_const bool sc_OITMaxLayers4Plus1 81
//spec_const bool sc_OITMaxLayers8 82
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 83
//spec_const bool sc_ProjectiveShadowsCaster 84
//spec_const bool sc_ProjectiveShadowsReceiver 85
//spec_const bool sc_RenderAlphaToColor 86
//spec_const bool sc_SSAOEnabled 87
//spec_const bool sc_ScreenTextureHasSwappedViews 88
//spec_const bool sc_ShaderComplexityAnalyzer 89
//spec_const bool sc_TAAEnabled 90
//spec_const bool sc_UseFramebufferFetchMarker 91
//spec_const bool sc_VertexBlending 92
//spec_const bool sc_VertexBlendingUseNormals 93
//spec_const int SC_DEVICE_CLASS 94
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 95
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 96
//spec_const int SC_SOFTWARE_WRAP_MODE_U_maskTex 97
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 98
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 99
//spec_const int SC_SOFTWARE_WRAP_MODE_V_maskTex 100
//spec_const int baseTexLayout 101
//spec_const int intensityTextureLayout 102
//spec_const int maskTexLayout 103
//spec_const int sc_AmbientLightMode0 104
//spec_const int sc_AmbientLightMode1 105
//spec_const int sc_AmbientLightMode2 106
//spec_const int sc_AmbientLightMode_Constant 107
//spec_const int sc_AmbientLightMode_EnvironmentMap 108
//spec_const int sc_AmbientLightMode_FromCamera 109
//spec_const int sc_AmbientLightMode_SphericalHarmonics 110
//spec_const int sc_AmbientLightsCount 111
//spec_const int sc_DepthBufferMode 112
//spec_const int sc_DirectionalLightsCount 113
//spec_const int sc_EnvLightMode 114
//spec_const int sc_EnvmapDiffuseLayout 115
//spec_const int sc_EnvmapSpecularLayout 116
//spec_const int sc_LightEstimationSGCount 117
//spec_const int sc_MaxTextureImageUnits 118
//spec_const int sc_PointLightsCount 119
//spec_const int sc_RenderingSpace 120
//spec_const int sc_ScreenTextureLayout 121
//spec_const int sc_ShaderCacheConstant 122
//spec_const int sc_SkinBonesCount 123
//spec_const int sc_StereoRenderingMode 124
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 125
//spec_const int sc_StereoViewID 126
//SG_REFLECTION_END
...
uniform vec4 maskTexSize;
uniform vec4 maskTexView;
uniform mat3 maskTexTransform;
uniform vec4 maskTexUvMinMax;
uniform vec4 maskTexBorderColor;
uniform float radius;
uniform float softness;
uniform vec3 Port_Normal_N023;
uniform vec3 Port_Emissive_N023;
uniform vec3 Port_AO_N023;
uniform vec3 Port_SpecularAO_N023;
uniform float Port_Import_N055;
uniform float Port_Import_N029;
uniform float Port_Import_N053;
uniform float Port_Input1_N047;
uniform float Port_Input2_N047;
uniform float Port_Import_N054;
uniform float Port_Input2_N051;
uniform float Port_Input2_N010;
uniform float Port_Input1_N001;
uniform float Port_Input2_N001;
...
#endif
#ifndef maskTexHasSwappedViews
#define maskTexHasSwappedViews 0
#elif maskTexHasSwappedViews==1
#undef maskTexHasSwappedViews
#define maskTexHasSwappedViews 1
#endif
#ifndef maskTexLayout
#define maskTexLayout 0
#endif
...
#endif
#ifndef ENABLE_SMOOTH_EDGES
#define ENABLE_SMOOTH_EDGES 0
#elif ENABLE_SMOOTH_EDGES==1
#undef ENABLE_SMOOTH_EDGES
#define ENABLE_SMOOTH_EDGES 1
#endif
#ifndef ENABLE_FACE_TEX
#define ENABLE_FACE_TEX 0
#elif ENABLE_FACE_TEX==1
#undef ENABLE_FACE_TEX
#define ENABLE_FACE_TEX 1
#endif
#ifndef SC_USE_UV_TRANSFORM_maskTex
#define SC_USE_UV_TRANSFORM_maskTex 0
#elif SC_USE_UV_TRANSFORM_maskTex==1
#undef SC_USE_UV_TRANSFORM_maskTex
#define SC_USE_UV_TRANSFORM_maskTex 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_maskTex
#define SC_SOFTWARE_WRAP_MODE_U_maskTex -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_maskTex
#define SC_SOFTWARE_WRAP_MODE_V_maskTex -1
#endif
#ifndef SC_USE_UV_MIN_MAX_maskTex
#define SC_USE_UV_MIN_MAX_maskTex 0
#elif SC_USE_UV_MIN_MAX_maskTex==1
#undef SC_USE_UV_MIN_MAX_maskTex
#define SC_USE_UV_MIN_MAX_maskTex 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_maskTex
#define SC_USE_CLAMP_TO_BORDER_maskTex 0
#elif SC_USE_CLAMP_TO_BORDER_maskTex==1
#undef SC_USE_CLAMP_TO_BORDER_maskTex
#define SC_USE_CLAMP_TO_BORDER_maskTex 1
#endif
#ifndef sc_DepthOnly
...
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),baseTexLayout,l9_2);
...
#endif
float l9_27=clamp(l9_1.w,0.0,1.0);
...
#endif
vec3 l9_28=max(l9_1.xyz,vec3(0.0));
vec4 l9_29;
#if (sc_ProjectiveShadowsCaster)
{
l9_29=vec4(l9_28,l9_27);
}
#else
{
float l9_30=clamp(metallic,0.0,1.0);
float l9_31=clamp(roughness,0.0,1.0);
vec3 l9_32=ssSRGB_to_Linear(l9_28);
vec3 l9_33=normalize(l9_26);
vec3 l9_34=ssSRGB_to_Linear(Port_Emissive_N023);
vec3 l9_35;
#if (sc_SSAOEnabled)
{
l9_35=evaluateSSAO(varPos);
}
#else
{
l9_35=Port_AO_N023;
...
#endif
vec3 l9_36=vec3(l9_30);
vec3 l9_37=mix(vec3(0.039999999),l9_32*l9_30,l9_36);
vec3 l9_38=mix(l9_32*(1.0-l9_30),vec3(0.0),l9_36);
SurfaceProperties l9_39=SurfaceProperties(l9_38,l9_27,l9_33,varPos,l9_0,l9_30,l9_31,l9_34,l9_35,Port_SpecularAO_N023,vec3(1.0),l9_37);
vec4 l9_40=vec4(1.0);
vec3 l9_41;
vec3 l9_42;
vec3 l9_43;
...
l9_49=vec3(0.0);
l9_48=vec3(0.0);
LightingComponents l9_55;
LightProperties l9_56;
SurfaceProperties l9_57;
vec3 l9_58;
int l9_59=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_59<sc_DirectionalLightsCount)
{
LightingComponents l9_60=accumulateLight(LightingComponents(l9_48,l9_49,l9_54,l9_53,l9_51,l9_50),LightProperties(sc_DirectionalLights[l9_59].direction,sc_DirectionalLights[l9_59].color.xyz,sc_DirectionalLights[l9_59].color.w*l9_40[(l9_52<3) ? l9_52 : 3]),l9_39,l9_0);
l9_54=l9_60.indirectDiffuse;
l9_53=l9_60.indirectSpecular;
l9_52++;
l9_51=l9_60.emitted;
l9_50=l9_60.transmitted;
l9_49=l9_60.directSpecular;
l9_48=l9_60.directDiffuse;
l9_59++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_77<sc_PointLightsCount)
{
vec3 l9_79=sc_PointLights[l9_77].position-varPos;
vec3 l9_80=normalize(l9_79);
float l9_81=l9_40[(l9_78<3) ? l9_78 : 3];
float l9_82=clamp((dot(l9_80,sc_PointLights[l9_77].direction)*sc_PointLights[l9_77].angleScale)+sc_PointLights[l9_77].angleOffset,0.0,1.0);
float l9_83=(sc_PointLights[l9_77].color.w*l9_81)*(l9_82*l9_82);
float l9_84;
if (sc_PointLights[l9_77].falloffEnabled)
{
l9_84=l9_83*computeDistanceAttenuation(length(l9_79),sc_PointLights[l9_77].falloffEndDistance);
}
else
{
l9_84=l9_83;
...
l9_70=l9_78+1;
LightingComponents l9_85=accumulateLight(LightingComponents(l9_64,l9_65,l9_69,l9_68,l9_67,l9_66),LightProperties(l9_80,sc_PointLights[l9_77].color.xyz,l9_84),l9_39,l9_0);
l9_71=l9_85.directDiffuse;
l9_72=l9_85.directSpecular;
l9_73=l9_85.indirectDiffuse;
l9_74=l9_85.indirectSpecular;
l9_75=l9_85.emitted;
l9_76=l9_85.transmitted;
l9_69=l9_73;
l9_68=l9_74;
l9_78=l9_70;
l9_67=l9_75;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_89=abs(varShadowTex-vec2(0.5));
vec4 l9_90=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_89.x,l9_89.y),0.5);
l9_88=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_90.xyz,vec3(sc_ShadowColor.w)),vec3(l9_90.w*sc_ShadowDensity));
}
#else
{
l9_88=vec3(1.0);
...
{
vec2 l9_92=calcPanoramicTexCoordsFromDir(l9_33,sc_EnvmapRotation.y);
vec4 l9_93;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_94=calcSeamlessPanoramicUvsForSampling(l9_92,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_94=l9_92;
...
#endif
l9_93=sc_EnvmapSpecularSampleViewIndexBias(l9_94,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_95;
...
{
vec2 l9_96=calcSeamlessPanoramicUvsForSampling(l9_92,sc_EnvmapDiffuseSize.xy,0.0);
int l9_97;
...
#endif
l9_95=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_96,sc_EnvmapDiffuseLayout,l9_97).xy,-13.0);
}
#else
{
l9_95=sc_EnvmapSpecularSampleViewIndexBias(l9_92,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_93=l9_95;
}
#endif
l9_91=(l9_93.xyz*(1.0/l9_93.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_98;
...
float l9_101=l9_99.y;
float l9_102=l9_99.z;
l9_98=(((((((sc_Sh[8]*0.42904299)*((l9_100*l9_100)-(l9_101*l9_101)))+((sc_Sh[6]*0.74312502)*(l9_102*l9_102)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_100*l9_101))+(sc_Sh[7]*(l9_100*l9_102)))+(sc_Sh[5]*(l9_101*l9_102)))*0.85808599))+((((sc_Sh[3]*l9_100)+(sc_Sh[1]*l9_101))+(sc_Sh[2]*l9_102))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_98=vec3(0.0);
...
{
l9_104=l9_91+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_105=l9_91;
l9_105.x=l9_91.x+(1e-06*sc_AmbientLights[0].color.x);
l9_104=l9_105;
}
#endif
l9_103=l9_104;
...
{
l9_107=l9_103+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_108=l9_103;
l9_108.x=l9_103.x+(1e-06*sc_AmbientLights[1].color.x);
l9_107=l9_108;
}
#endif
l9_106=l9_107;
...
{
l9_110=l9_106+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_111=l9_106;
l9_111.x=l9_106.x+(1e-06*sc_AmbientLights[2].color.x);
l9_110=l9_111;
}
#endif
l9_109=l9_110;
...
{
vec3 l9_113;
l9_113=sc_LightEstimationData.ambientLight;
vec3 l9_114;
int l9_115=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_115<sc_LightEstimationSGCount)
{
float l9_116=dot(sc_LightEstimationData.sg[l9_115].axis,l9_33);
float l9_117=exp(-sc_LightEstimationData.sg[l9_115].sharpness);
float l9_118=l9_117*l9_117;
float l9_119=1.0/sc_LightEstimationData.sg[l9_115].sharpness;
float l9_120=(1.0+(2.0*l9_118))-l9_119;
float l9_121=sqrt(1.0-l9_120);
float l9_122=0.36000001*l9_116;
float l9_123=(1.0/(4.0*0.36000001))*l9_121;
float l9_124=l9_122+l9_123;
float l9_125;
if (step(abs(l9_122),l9_123)>0.5)
{
l9_125=(l9_124*l9_124)/l9_121;
}
else
{
l9_125=clamp(l9_116,0.0,1.0);
}
l9_114=l9_113+((((sc_LightEstimationData.sg[l9_115].color/vec3(sc_LightEstimationData.sg[l9_115].sharpness))*6.2831855)*((l9_120*l9_125)+(((l9_117-l9_118)*l9_119)-l9_118)))/vec3(3.1415927));
l9_113=l9_114;
l9_115++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_127=clamp(pow(l9_31,0.66666669),0.0,1.0)*5.0;
vec2 l9_128=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_33,reflect(-l9_0,l9_33),l9_31),sc_EnvmapRotation.y);
vec4 l9_129;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_130=floor(l9_127);
float l9_131=ceil(l9_127);
l9_129=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_128,sc_EnvmapSpecularSize.xy,l9_130),sc_EnvmapSpecularGetStereoViewIndex(),l9_130),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_128,sc_EnvmapSpecularSize.xy,l9_131),sc_EnvmapSpecularGetStereoViewIndex(),l9_131),vec4(l9_127-l9_130));
}
#else
{
l9_129=sc_EnvmapSpecularSampleViewIndexLevel(l9_128,sc_EnvmapSpecularGetStereoViewIndex(),l9_127);
}
#endif
l9_126=vec3(0.0)+((((l9_129.xyz*(1.0/l9_129.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_39,abs(dot(l9_33,l9_0))));
}
#else
{
l9_126=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_133=clamp(l9_31*l9_31,0.0099999998,1.0);
vec3 l9_134;
l9_134=sc_LightEstimationData.ambientLight*l9_37;
int l9_135=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_135<sc_LightEstimationSGCount)
{
float l9_136=l9_133*l9_133;
vec3 l9_137=reflect(-l9_0,l9_33);
float l9_138=dot(l9_33,l9_0);
float l9_139=(2.0/l9_136)/(4.0*max(l9_138,9.9999997e-05));
float l9_140=length((l9_137*l9_139)+(sc_LightEstimationData.sg[l9_135].axis*sc_LightEstimationData.sg[l9_135].sharpness));
float l9_141=clamp(dot(l9_33,l9_137),0.0,1.0);
float l9_142=clamp(l9_138,0.0,1.0);
float l9_143=1.0-l9_136;
l9_134+=((((((((vec3(1.0/(3.1415927*l9_136))*exp((l9_140-l9_139)-sc_LightEstimationData.sg[l9_135].sharpness))*sc_LightEstimationData.sg[l9_135].color)*6.2831855)*(1.0-exp((-2.0)*l9_140)))/vec3(l9_140))*((1.0/(l9_141+sqrt(l9_136+((l9_143*l9_141)*l9_141))))*(1.0/(l9_142+sqrt(l9_136+((l9_143*l9_142)*l9_142))))))*(l9_37+((vec3(1.0)-l9_37)*pow(1.0-clamp(dot(l9_137,normalize(l9_137+l9_0)),0.0,1.0),5.0))))*l9_141);
l9_135++;
continue;
}
else
...
l9_147=vec3(0.0);
l9_146=vec3(0.0);
l9_145=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_38,vec3(l9_27));
l9_144=1.0;
}
#else
{
...
#endif
vec3 l9_149=l9_146*l9_35;
vec3 l9_150=l9_147+l9_149;
vec3 l9_151=l9_38*l9_150;
vec3 l9_152=l9_132*Port_SpecularAO_N023;
vec3 l9_153=l9_86+l9_152;
vec3 l9_154;
if (l9_148)
{
l9_154=l9_151*srgbToLinear(l9_144);
}
else
{
l9_154=l9_151;
}
vec3 l9_155=l9_154+l9_153;
vec3 l9_156=(l9_155+l9_34)+l9_145;
float l9_157=l9_156.x;
vec4 l9_158=vec4(l9_157,l9_156.yz,l9_144);
vec4 l9_159;
#if (sc_IsEditor)
{
vec4 l9_160=l9_158;
l9_160.x=l9_157+((l9_35.x*Port_SpecularAO_N023.x)*9.9999997e-06);
l9_159=l9_160;
}
#else
{
...
{
vec3 l9_162=l9_159.xyz*1.8;
vec3 l9_163=(l9_159.xyz*(l9_162+vec3(1.4)))/((l9_159.xyz*(l9_162+vec3(0.5)))+vec3(1.5));
l9_161=vec4(l9_163.x,l9_163.y,l9_163.z,l9_159.w);
}
#else
{
l9_161=l9_159;
...
#endif
vec3 l9_164=vec3(linearToSrgb(l9_161.x),linearToSrgb(l9_161.y),linearToSrgb(l9_161.z));
l9_29=vec4(l9_164.x,l9_164.y,l9_164.z,l9_161.w);
}
#endif
vec4 l9_165=max(l9_29,vec4(0.0));
float l9_166;
#if (ENABLE_SMOOTH_EDGES)
{
float l9_167;
#if (ENABLE_FACE_TEX)
{
int l9_168;
#if (maskTexHasSwappedViews)
{
l9_168=1-sc_GetStereoViewIndex();
}
#else
{
l9_168=sc_GetStereoViewIndex();
}
#endif
float l9_169=varPackedTex.x;
sc_SoftwareWrapEarly(l9_169,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTex,SC_SOFTWARE_WRAP_MODE_V_maskTex).x);
float l9_170=l9_169;
float l9_171=varPackedTex.y;
sc_SoftwareWrapEarly(l9_171,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTex,SC_SOFTWARE_WRAP_MODE_V_maskTex).y);
float l9_172=l9_171;
vec2 l9_173;
float l9_174;
#if (SC_USE_UV_MIN_MAX_maskTex)
{
bool l9_175;
#if (SC_USE_CLAMP_TO_BORDER_maskTex)
{
l9_175=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTex,SC_SOFTWARE_WRAP_MODE_V_maskTex).x==3;
}
#else
{
l9_175=(int(SC_USE_CLAMP_TO_BORDER_maskTex)!=0);
}
#endif
float l9_176=l9_170;
float l9_177=1.0;
sc_ClampUV(l9_176,maskTexUvMinMax.x,maskTexUvMinMax.z,l9_175,l9_177);
float l9_178=l9_176;
float l9_179=l9_177;
bool l9_180;
#if (SC_USE_CLAMP_TO_BORDER_maskTex)
{
l9_180=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTex,SC_SOFTWARE_WRAP_MODE_V_maskTex).y==3;
}
#else
{
l9_180=(int(SC_USE_CLAMP_TO_BORDER_maskTex)!=0);
}
#endif
float l9_181=l9_172;
float l9_182=l9_179;
sc_ClampUV(l9_181,maskTexUvMinMax.y,maskTexUvMinMax.w,l9_180,l9_182);
l9_174=l9_182;
...
#endif
vec2 l9_183=sc_TransformUV(l9_173,(int(SC_USE_UV_TRANSFORM_maskTex)!=0),maskTexTransform);
float l9_184=l9_183.x;
float l9_185=l9_174;
sc_SoftwareWrapLate(l9_184,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTex,SC_SOFTWARE_WRAP_MODE_V_maskTex).x,(int(SC_USE_CLAMP_TO_BORDER_maskTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_maskTex)!=0)),l9_185);
float l9_186=l9_183.y;
float l9_187=l9_185;
sc_SoftwareWrapLate(l9_186,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTex,SC_SOFTWARE_WRAP_MODE_V_maskTex).y,(int(SC_USE_CLAMP_TO_BORDER_maskTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_maskTex)!=0)),l9_187);
float l9_188=l9_187;
vec3 l9_189=sc_SamplingCoordsViewToGlobal(vec2(l9_184,l9_186),maskTexLayout,l9_168);
vec4 l9_190=texture2D(maskTex,l9_189.xy,0.0);
vec4 l9_191;
#if (SC_USE_CLAMP_TO_BORDER_maskTex)
{
l9_191=mix(maskTexBorderColor,l9_190,vec4(l9_188));
}
#else
{
l9_191=l9_190;
...
#endif
float l9_192;
if ((float(softness>radius)*1.0)!=0.0)
{
l9_192=radius;
}
else
...
l9_167=(clamp((l9_191.x-(1.0-radius))+0.001,Port_Input1_N047+0.001,Port_Input2_N047+0.001)-0.001)/l9_192;
}
#else
{
l9_167=Port_Input2_N051;
}
#endif
l9_166=l9_167;
}
#else
{
l9_166=Port_Input2_N010;
}
#endif
float l9_193=l9_1.w*l9_166;
float l9_194=clamp(l9_193+0.001,Port_Input1_N001+0.001,Port_Input2_N001+0.001)-0.001;
vec4 l9_195=vec4(l9_165.x,l9_165.y,l9_165.z,vec4(0.0).w);
l9_195.w=l9_194;
vec4 l9_196;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_198=clamp(l9_194*2.0,0.0,1.0);
}
#else
{
float l9_199;
...
{
l9_199=clamp(dot(l9_195.xyz,vec3(l9_194)),0.0,1.0);
}
#else
{
float l9_200;
...
#if (sc_BlendMode_Multiply)
{
l9_201=(1.0-dot(l9_195.xyz,vec3(0.33333001)))*l9_194;
}
#else
{
float l9_202;
...
{
l9_202=(1.0-clamp(dot(l9_195.xyz,vec3(1.0)),0.0,1.0))*l9_194;
}
#else
{
float l9_203;
#if (sc_BlendMode_ColoredGlass)
{
l9_203=clamp(dot(l9_195.xyz,vec3(1.0)),0.0,1.0)*l9_194;
}
#else
{
float l9_204;
#if (sc_BlendMode_Add)
{
l9_204=clamp(dot(l9_195.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_205;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_205=clamp(dot(l9_195.xyz,vec3(1.0)),0.0,1.0)*l9_194;
}
#else
{
float l9_206;
...
{
l9_206=dot(l9_195.xyz,vec3(0.33333001))*l9_194;
}
#else
{
float l9_207;
#if (sc_BlendMode_Min)
{
l9_207=1.0-clamp(dot(l9_195.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_208;
#if (sc_BlendMode_Max)
{
l9_208=clamp(dot(l9_195.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_208=1.0;
...
#endif
l9_196=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_195.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_197);
}
#else
{
vec4 l9_209;
...
{
vec3 l9_211=sc_GetFramebufferColor().xyz;
vec3 l9_212=mix(l9_211,definedBlend(l9_211,l9_195.xyz).xyz,vec3(l9_194));
vec4 l9_213=vec4(l9_212.x,l9_212.y,l9_212.z,vec4(0.0).w);
l9_213.w=1.0;
l9_210=l9_213;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_214=vec4(mix(vec3(1.0),l9_195.xyz,vec3(l9_194)),l9_194);
}
#else
{
vec4 l9_215;
...
#endif
l9_215=vec4(l9_195.xyz*l9_216,l9_216);
}
#else
{
l9_215=l9_195;
...
{
l9_219=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_219=vec4(0.0);
...
vec4 l9_221=outputMotionVectorsIfNeeded(varPos,max(l9_220,vec4(0.0)));
vec4 l9_222=clamp(l9_221,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_223=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_223-0.0039215689)),min(1.0,l9_223+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_224=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_224).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_225=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_224).xy);
float l9_226=packValue(l9_225);
int l9_233=int(l9_222.w*255.0);
float l9_234=packValue(l9_233);
sc_writeFragData0(vec4(packValue(l9_225),packValue(l9_225),packValue(l9_225),packValue(l9_225)));
sc_writeFragData1(vec4(l9_226,packValue(l9_225),packValue(l9_225),packValue(l9_225)));
sc_writeFragData2(vec4(l9_234,packValue(l9_233),packValue(l9_233),packValue(l9_233)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_237=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_237).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_242==0)
{
l9_245=texture2D(sc_OITAlpha0,l9_237);
l9_244=texture2D(sc_OITDepthLow0,l9_237);
l9_243=texture2D(sc_OITDepthHigh0,l9_237);
}
else
{
l9_245=vec4(0.0);
...
if (l9_242==1)
{
l9_248=texture2D(sc_OITAlpha1,l9_237);
l9_247=texture2D(sc_OITDepthLow1,l9_237);
l9_246=texture2D(sc_OITDepthHigh1,l9_237);
}
else
{
l9_248=l9_245;
...
if (any(notEqual(l9_246,vec4(0.0)))||any(notEqual(l9_247,vec4(0.0))))
{
int l9_249[8]=l9_238;
unpackValues(l9_246.w,l9_242,l9_249);
unpackValues(l9_246.z,l9_242,l9_249);
unpackValues(l9_246.y,l9_242,l9_249);
unpackValues(l9_246.x,l9_242,l9_249);
unpackValues(l9_247.w,l9_242,l9_249);
unpackValues(l9_247.z,l9_242,l9_249);
unpackValues(l9_247.y,l9_242,l9_249);
unpackValues(l9_247.x,l9_242,l9_249);
int l9_258[8]=l9_239;
unpackValues(l9_248.w,l9_242,l9_258);
unpackValues(l9_248.z,l9_242,l9_258);
unpackValues(l9_248.y,l9_242,l9_258);
unpackValues(l9_248.x,l9_242,l9_258);
}
l9_242++;
continue;
}
...
vec4 l9_263=texture2D(sc_OITFilteredDepthBoundsTexture,l9_237);
vec2 l9_264=l9_263.xy;
int l9_265;
#if (sc_SkinBonesCount>0)
{
l9_265=encodeDepth(((1.0-l9_263.x)*1000.0)+getDepthOrderingEpsilon(),l9_264);
}
#else
{
l9_265=0;
...
#endif
int l9_266=encodeDepth(viewSpaceDepth(),l9_264);
vec4 l9_267;
l9_267=l9_222*l9_222.w;
vec4 l9_268;
int l9_269=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_269<8)
{
int l9_270=l9_238[l9_269];
int l9_271=l9_266-l9_265;
bool l9_272=l9_270<l9_271;
bool l9_273;
if (l9_272)
{
l9_273=l9_238[l9_269]>0;
}
else
{
l9_273=l9_272;
...
if (l9_273)
{
vec3 l9_274=l9_267.xyz*(1.0-(float(l9_239[l9_269])/255.0));
l9_268=vec4(l9_274.x,l9_274.y,l9_274.z,l9_267.w);
}
else
{
l9_268=l9_267;
...
sc_writeFragData0(l9_222);
}
#endif
}
#else
{
sc_writeFragData0(l9_221);
}
#endif
}
#endif
