...
#endif
vec2 l9_0=vec2(length(sc_ModelMatrix[0].xyz),length(sc_ModelMatrix[1].xyz));
bool l9_1=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w+0.00050000002)>0.0;
bool l9_2;
if (l9_1)
{
l9_2=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w-0.00050000002)<0.0;
}
else
{
l9_2=l9_1;
...
if (!l9_2)
{
l9_3=l9_0*(abs(vec2(0.0,sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][1].y)).y/0.1);
}
else
{
l9_3=l9_0;
}
float l9_4=min(min(borderScale,l9_3.x/2.0),l9_3.y/2.0);
float l9_5=(baseTexSize.x/baseTexSize.y)*l9_4;
float l9_6=((sliceSizeLeft*l9_5)*2.0)/l9_3.x;
float l9_7=1.0-(((sliceSizeRight*l9_5)*2.0)/l9_3.x);
float l9_8=((sliceSizeBottom*l9_4)*2.0)/l9_3.y;
float l9_9=1.0-(((sliceSizeTop*l9_4)*2.0)/l9_3.y);
float l9_10=1.0-sliceSizeRight;
float l9_11=1.0-sliceSizeTop;
float l9_12;
if (varPackedTex.x<l9_6)
{
l9_12=0.0+(((varPackedTex.x-0.0)*(sliceSizeLeft-0.0))/(l9_6-0.0));
}
else
{
l9_12=(varPackedTex.x<l9_7) ? (sliceSizeLeft+(((varPackedTex.x-l9_6)*(l9_10-sliceSizeLeft))/(l9_7-l9_6))) : (l9_10+(((varPackedTex.x-l9_7)*(1.0-l9_10))/(1.0-l9_7)));
}
float l9_13;
if (varPackedTex.y<l9_8)
{
l9_13=0.0+(((varPackedTex.y-0.0)*(sliceSizeBottom-0.0))/(l9_8-0.0));
}
else
{
l9_13=(varPackedTex.y<l9_9) ? (sliceSizeBottom+(((varPackedTex.y-l9_8)*(l9_11-sliceSizeBottom))/(l9_9-l9_8))) : (l9_11+(((varPackedTex.y-l9_9)*(1.0-l9_11))/(1.0-l9_9)));
}
int l9_14;
...
float l9_34=l9_33;
vec3 l9_35=sc_SamplingCoordsViewToGlobal(vec2(l9_30,l9_32),baseTexLayout,l9_14);
...
#endif
l9_55=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_59,sc_ScreenTextureLayout,l9_60).xy,0.0);
}
#endif
vec4 l9_61;
