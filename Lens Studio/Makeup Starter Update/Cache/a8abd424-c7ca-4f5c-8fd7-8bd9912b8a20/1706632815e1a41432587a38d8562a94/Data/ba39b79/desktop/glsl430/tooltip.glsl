...
vec2 l9_2=vec2(length(sc_ModelMatrix[0].xyz),length(sc_ModelMatrix[1].xyz));
bool l9_3=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w+0.00050000002)>0.0;
bool l9_4;
if (l9_3)
{
l9_4=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w-0.00050000002)<0.0;
}
else
{
l9_4=l9_3;
...
if (!l9_4)
{
l9_5=l9_2*(abs(vec2(0.0,sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][1].y)).y/0.1);
}
else
{
l9_5=l9_2;
}
float l9_6=min(min(borderScale,l9_5.x/2.0),l9_5.y/2.0);
float l9_7=(baseTexSize.x/baseTexSize.y)*l9_6;
float l9_8=((sliceSizeLeft*l9_7)*2.0)/l9_5.x;
float l9_9=1.0-(((sliceSizeRight*l9_7)*2.0)/l9_5.x);
float l9_10=((sliceSizeBottom*l9_6)*2.0)/l9_5.y;
float l9_11=1.0-(((sliceSizeTop*l9_6)*2.0)/l9_5.y);
float l9_12=1.0-sliceSizeRight;
float l9_13=1.0-sliceSizeTop;
float l9_14;
if (l9_0.x<l9_8)
{
l9_14=0.0+(((l9_0.x-0.0)*(sliceSizeLeft-0.0))/(l9_8-0.0));
}
else
{
l9_14=(l9_0.x<l9_9) ? (sliceSizeLeft+(((l9_0.x-l9_8)*(l9_12-sliceSizeLeft))/(l9_9-l9_8))) : (l9_12+(((l9_0.x-l9_9)*(1.0-l9_12))/(1.0-l9_9)));
}
float l9_15;
if (l9_0.y<l9_10)
{
l9_15=0.0+(((l9_0.y-0.0)*(sliceSizeBottom-0.0))/(l9_10-0.0));
}
else
{
l9_15=(l9_0.y<l9_11) ? (sliceSizeBottom+(((l9_0.y-l9_10)*(l9_13-sliceSizeBottom))/(l9_11-l9_10))) : (l9_13+(((l9_0.y-l9_11)*(1.0-l9_13))/(1.0-l9_11)));
}
vec4 l9_16;
#if (baseTexLayout==2)
{
...
float l9_32=l9_31.x;
float l9_33=l9_22;
sc_SoftwareWrapLate(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_33);
float l9_34=l9_31.y;
float l9_35=l9_33;
sc_SoftwareWrapLate(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_35);
float l9_36=l9_35;
...
float l9_55=l9_54.x;
float l9_56=l9_45;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_56);
float l9_57=l9_54.y;
float l9_58=l9_56;
sc_SoftwareWrapLate(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_58);
float l9_59=l9_58;
...
#endif
vec4 l9_63=l9_16*shapeColor;
float l9_64=l9_63.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_64<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_64<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_65,vec4(0.0)));
return;
}
vec4 l9_67;
...
{
l9_70=clamp(dot(l9_63.xyz,vec3(l9_64)),0.0,1.0);
}
#else
{
float l9_71;
...
{
l9_72=(1.0-dot(l9_63.xyz,vec3(0.33333001)))*l9_64;
}
#else
{
float l9_73;
...
{
l9_73=(1.0-clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0))*l9_64;
}
#else
{
float l9_74;
...
{
l9_74=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0)*l9_64;
}
#else
{
float l9_75;
#if (sc_BlendMode_Add)
{
l9_75=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_76;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_76=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0)*l9_64;
}
#else
{
float l9_77;
...
{
l9_77=dot(l9_63.xyz,vec3(0.33333001))*l9_64;
}
#else
{
float l9_78;
#if (sc_BlendMode_Min)
{
l9_78=1.0-clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_79;
#if (sc_BlendMode_Max)
{
l9_79=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_79=1.0;
...
#endif
l9_67=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_63.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_68);
}
#else
{
vec4 l9_80;
...
#if (sc_FramebufferFetch)
{
vec4 l9_83=sc_readFragData0_Platform();
vec4 l9_84;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_85=l9_83;
l9_85.x=l9_83.x+_sc_framebufferFetchMarker;
l9_84=l9_85;
}
#else
{
...
{
l9_87=1-sc_GetStereoViewIndex();
}
#else
{
l9_87=sc_GetStereoViewIndex();
}
#endif
vec4 l9_88;
#if (sc_ScreenTextureLayout==2)
{
l9_88=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_86,sc_ScreenTextureLayout,l9_87),0.0);
}
#else
{
l9_88=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_86,sc_ScreenTextureLayout,l9_87).xy,0.0);
}
#endif
l9_82=l9_88;
}
...
{
vec4 l9_90=l9_82;
l9_90.x=l9_82.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_89=l9_90;
}
#else
{
...
#endif
vec3 l9_91=mix(l9_89.xyz,definedBlend(l9_89.xyz,l9_63.xyz).xyz,vec3(l9_64));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_93=vec4(mix(vec3(1.0),l9_63.xyz,vec3(l9_64)),l9_64);
}
#else
{
vec4 l9_94;
...
#endif
l9_94=vec4(l9_63.xyz*l9_95,l9_95);
}
#else
{
l9_94=l9_63;
...
{
l9_98=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_98=vec4(0.0);
...
vec4 l9_100=outputMotionVectorsIfNeeded(varPos,max(l9_99,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_102-0.0039215689)),min(1.0,l9_102+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_104),packValue(l9_104),packValue(l9_104),packValue(l9_104)));
