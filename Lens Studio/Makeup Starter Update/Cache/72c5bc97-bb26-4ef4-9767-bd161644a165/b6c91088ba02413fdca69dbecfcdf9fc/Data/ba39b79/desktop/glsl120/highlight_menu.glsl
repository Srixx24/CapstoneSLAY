...
{
vec2 l9_240=N7_getUV(NODE_221_DROPLIST_ITEM);
int l9_241;
#if (materialParamsTexHasSwappedViews)
{
l9_241=1-sc_GetStereoViewIndex();
}
#else
{
l9_241=sc_GetStereoViewIndex();
}
#endif
float l9_242=l9_240.x;
sc_SoftwareWrapEarly(l9_242,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_243=l9_242;
float l9_244=l9_240.y;
sc_SoftwareWrapEarly(l9_244,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_245=l9_244;
vec2 l9_246;
float l9_247;
...
{
l9_248=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_248=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_249=l9_243;
float l9_250=1.0;
sc_ClampUV(l9_249,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_248,l9_250);
float l9_251=l9_249;
float l9_252=l9_250;
bool l9_253;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_253=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_253=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_254=l9_245;
float l9_255=l9_252;
sc_ClampUV(l9_254,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_253,l9_255);
l9_247=l9_255;
...
#endif
vec2 l9_256=sc_TransformUV(l9_246,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_257=l9_256.x;
float l9_258=l9_247;
sc_SoftwareWrapLate(l9_257,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_258);
float l9_259=l9_256.y;
float l9_260=l9_258;
sc_SoftwareWrapLate(l9_259,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_260);
}
#endif
vec3 l9_261;
...
#endif
float l9_262=clamp(l9_63,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_262<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_262<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_263=max(l9_62.xyz,vec3(0.0));
vec4 l9_264;
#if (sc_ProjectiveShadowsCaster)
{
l9_264=vec4(l9_263,l9_262);
}
#else
{
vec3 l9_265=ssSRGB_to_Linear(l9_263);
vec3 l9_266=normalize(l9_261);
vec3 l9_267=ssSRGB_to_Linear(max(l9_239,vec3(0.0)));
vec3 l9_268;
#if (sc_SSAOEnabled)
{
l9_268=evaluateSSAO(varPos);
}
#else
{
l9_268=Port_AO_N036;
...
#endif
vec3 l9_269=l9_265*(1.0-0.0);
SurfaceProperties l9_270=SurfaceProperties(l9_269,l9_262,l9_266,varPos,l9_6,0.0,1.0,l9_267,l9_268,vec3(1.0),vec3(1.0),vec3(0.039999999));
vec4 l9_271=vec4(1.0);
vec3 l9_272;
vec3 l9_273;
vec3 l9_274;
vec3 l9_275;
...
l9_280=vec3(0.0);
l9_279=vec3(0.0);
LightingComponents l9_286;
LightProperties l9_287;
SurfaceProperties l9_288;
vec3 l9_289;
int l9_290=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_290<sc_DirectionalLightsCount)
{
LightingComponents l9_291=accumulateLight(LightingComponents(l9_279,l9_280,l9_285,l9_283,l9_282,l9_281),LightProperties(sc_DirectionalLights[l9_290].direction,sc_DirectionalLights[l9_290].color.xyz,sc_DirectionalLights[l9_290].color.w*l9_271[(l9_284<3) ? l9_284 : 3]),l9_270,l9_6);
l9_285=l9_291.indirectDiffuse;
l9_284++;
l9_283=l9_291.indirectSpecular;
l9_282=l9_291.emitted;
l9_281=l9_291.transmitted;
l9_280=l9_291.directSpecular;
l9_279=l9_291.directDiffuse;
l9_290++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_308<sc_PointLightsCount)
{
vec3 l9_310=sc_PointLights[l9_308].position-varPos;
vec3 l9_311=normalize(l9_310);
float l9_312=l9_271[(l9_309<3) ? l9_309 : 3];
float l9_313=clamp((dot(l9_311,sc_PointLights[l9_308].direction)*sc_PointLights[l9_308].angleScale)+sc_PointLights[l9_308].angleOffset,0.0,1.0);
float l9_314=(sc_PointLights[l9_308].color.w*l9_312)*(l9_313*l9_313);
float l9_315;
if (sc_PointLights[l9_308].falloffEnabled)
{
l9_315=l9_314*computeDistanceAttenuation(length(l9_310),sc_PointLights[l9_308].falloffEndDistance);
}
else
{
l9_315=l9_314;
...
l9_301=l9_309+1;
LightingComponents l9_316=accumulateLight(LightingComponents(l9_295,l9_296,l9_300,l9_299,l9_298,l9_297),LightProperties(l9_311,sc_PointLights[l9_308].color.xyz,l9_315),l9_270,l9_6);
l9_302=l9_316.directDiffuse;
l9_303=l9_316.directSpecular;
l9_304=l9_316.indirectDiffuse;
l9_305=l9_316.indirectSpecular;
l9_306=l9_316.emitted;
l9_307=l9_316.transmitted;
l9_300=l9_304;
l9_309=l9_301;
l9_299=l9_305;
l9_298=l9_306;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_319=abs(varShadowTex-vec2(0.5));
vec4 l9_320=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_319.x,l9_319.y),0.5);
l9_318=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_320.xyz,vec3(sc_ShadowColor.w)),vec3(l9_320.w*sc_ShadowDensity));
}
#else
{
l9_318=vec3(1.0);
...
{
float l9_322=-l9_266.z;
float l9_323=l9_266.x;
vec2 l9_324=vec2((((l9_323<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_322/length(vec2(l9_323,l9_322)),-1.0,1.0)))-1.5707964,acos(l9_266.y))/vec2(6.2831855,3.1415927);
float l9_325=l9_324.x+(sc_EnvmapRotation.y/360.0);
vec2 l9_326=vec2(l9_325,1.0-l9_324.y);
l9_326.x=fract((l9_325+floor(l9_325))+1.0);
vec4 l9_327;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_328=calcSeamlessPanoramicUvsForSampling(l9_326,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_328=l9_326;
...
#endif
l9_327=sc_EnvmapSpecularSampleViewIndexBias(l9_328,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_329;
...
{
vec2 l9_330=calcSeamlessPanoramicUvsForSampling(l9_326,sc_EnvmapDiffuseSize.xy,0.0);
int l9_331;
#if (sc_EnvmapDiffuseHasSwappedViews)
{
l9_331=1-sc_GetStereoViewIndex();
}
#else
{
l9_331=sc_GetStereoViewIndex();
}
#endif
l9_329=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_330,sc_EnvmapDiffuseLayout,l9_331).xy,-13.0);
}
#else
{
l9_329=sc_EnvmapSpecularSampleViewIndexBias(l9_326,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_327=l9_329;
}
#endif
l9_321=(l9_327.xyz*(1.0/l9_327.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_332;
...
l9_332=(((((((sc_Sh[8]*0.42904299)*((l9_334*l9_334)-(l9_335*l9_335)))+((sc_Sh[6]*0.74312502)*(l9_336*l9_336)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_334*l9_335))+(sc_Sh[7]*(l9_334*l9_336)))+(sc_Sh[5]*(l9_335*l9_336)))*0.85808599))+((((sc_Sh[3]*l9_334)+(sc_Sh[1]*l9_335))+(sc_Sh[2]*l9_336))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_332=vec3(0.0);
...
{
l9_338=l9_321+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_339=l9_321;
l9_339.x=l9_321.x+(1e-06*sc_AmbientLights[0].color.x);
l9_338=l9_339;
}
#endif
l9_337=l9_338;
...
{
l9_341=l9_337+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_342=l9_337;
l9_342.x=l9_337.x+(1e-06*sc_AmbientLights[1].color.x);
l9_341=l9_342;
}
#endif
l9_340=l9_341;
...
{
l9_344=l9_340+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_345=l9_340;
l9_345.x=l9_340.x+(1e-06*sc_AmbientLights[2].color.x);
l9_344=l9_345;
}
#endif
l9_343=l9_344;
...
{
vec3 l9_347;
l9_347=sc_LightEstimationData.ambientLight;
vec3 l9_348;
int l9_349=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_349<sc_LightEstimationSGCount)
{
float l9_350=dot(sc_LightEstimationData.sg[l9_349].axis,l9_266);
float l9_351=exp(-sc_LightEstimationData.sg[l9_349].sharpness);
float l9_352=l9_351*l9_351;
float l9_353=1.0/sc_LightEstimationData.sg[l9_349].sharpness;
float l9_354=(1.0+(2.0*l9_352))-l9_353;
float l9_355=sqrt(1.0-l9_354);
float l9_356=0.36000001*l9_350;
float l9_357=(1.0/(4.0*0.36000001))*l9_355;
float l9_358=l9_356+l9_357;
float l9_359;
if (step(abs(l9_356),l9_357)>0.5)
{
l9_359=(l9_358*l9_358)/l9_355;
}
else
{
l9_359=clamp(l9_350,0.0,1.0);
}
l9_348=l9_347+((((sc_LightEstimationData.sg[l9_349].color/vec3(sc_LightEstimationData.sg[l9_349].sharpness))*6.2831855)*((l9_354*l9_359)+(((l9_351-l9_352)*l9_353)-l9_352)))/vec3(3.1415927));
l9_347=l9_348;
l9_349++;
continue;
}
...
l9_363=vec3(0.0);
l9_362=vec3(0.0);
l9_361=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_269,vec3(l9_262));
l9_360=1.0;
}
#else
{
...
#endif
vec3 l9_365=l9_362*l9_268;
vec3 l9_366=l9_363+l9_365;
vec3 l9_367=l9_269*l9_366;
vec3 l9_368=l9_294*vec3(1.0);
vec3 l9_369;
if (l9_364)
{
l9_369=l9_367*srgbToLinear(l9_360);
}
else
{
l9_369=l9_367;
}
vec3 l9_370=l9_369+(vec3(0.0)+l9_368);
vec3 l9_371=(l9_370+l9_267)+l9_361;
float l9_372=l9_371.x;
vec4 l9_373=vec4(l9_372,l9_371.yz,l9_360);
vec4 l9_374;
#if (sc_IsEditor)
{
vec4 l9_375=l9_373;
l9_375.x=l9_372+((l9_268.x*1.0)*9.9999997e-06);
l9_374=l9_375;
}
#else
{
...
{
vec3 l9_377=l9_374.xyz*1.8;
vec3 l9_378=(l9_374.xyz*(l9_377+vec3(1.4)))/((l9_374.xyz*(l9_377+vec3(0.5)))+vec3(1.5));
l9_376=vec4(l9_378.x,l9_378.y,l9_378.z,l9_374.w);
}
#else
{
l9_376=l9_374;
...
#endif
vec3 l9_379=vec3(linearToSrgb(l9_376.x),linearToSrgb(l9_376.y),linearToSrgb(l9_376.z));
l9_264=vec4(l9_379.x,l9_379.y,l9_379.z,l9_376.w);
}
#endif
vec4 l9_380=max(l9_264,vec4(0.0));
vec4 l9_381;
#if (sc_ProjectiveShadowsCaster)
{
float l9_382;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_383=clamp(l9_380.w*2.0,0.0,1.0);
}
#else
{
float l9_384;
...
{
l9_384=clamp(dot(l9_380.xyz,vec3(l9_380.w)),0.0,1.0);
}
#else
{
float l9_385;
...
#if (sc_BlendMode_Multiply)
{
l9_386=(1.0-dot(l9_380.xyz,vec3(0.33333001)))*l9_380.w;
}
#else
{
float l9_387;
...
{
l9_387=(1.0-clamp(dot(l9_380.xyz,vec3(1.0)),0.0,1.0))*l9_380.w;
}
#else
{
float l9_388;
#if (sc_BlendMode_ColoredGlass)
{
l9_388=clamp(dot(l9_380.xyz,vec3(1.0)),0.0,1.0)*l9_380.w;
}
#else
{
float l9_389;
#if (sc_BlendMode_Add)
{
l9_389=clamp(dot(l9_380.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_390;
...
{
l9_391=dot(l9_380.xyz,vec3(0.33333001))*l9_380.w;
}
#else
{
float l9_392;
#if (sc_BlendMode_Min)
{
l9_392=1.0-clamp(dot(l9_380.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_393;
#if (sc_BlendMode_Max)
{
l9_393=clamp(dot(l9_380.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_393=1.0;
...
#endif
l9_381=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_380.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_382);
}
#else
{
vec4 l9_394;
...
{
vec3 l9_396=sc_GetFramebufferColor().xyz;
vec3 l9_397=mix(l9_396,definedBlend(l9_396,l9_380.xyz).xyz,vec3(l9_380.w));
vec4 l9_398=vec4(l9_397.x,l9_397.y,l9_397.z,vec4(0.0).w);
l9_398.w=1.0;
l9_395=l9_398;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_400=l9_380.w;
l9_399=vec4(mix(vec3(1.0),l9_380.xyz,vec3(l9_400)),l9_400);
}
#else
{
vec4 l9_401;
...
{
float l9_402=l9_380.w;
float l9_403;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_403=clamp(l9_402,0.0,1.0);
}
#else
{
l9_403=l9_402;
...
#endif
l9_401=vec4(l9_380.xyz*l9_403,l9_403);
}
#else
{
l9_401=l9_380;
...
{
l9_406=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_406=vec4(0.0);
...
vec4 l9_408=outputMotionVectorsIfNeeded(varPos,max(l9_407,vec4(0.0)));
vec4 l9_409=clamp(l9_408,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_410=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_410-0.0039215689)),min(1.0,l9_410+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_411=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_411).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_412=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_411).xy);
float l9_413=packValue(l9_412);
int l9_420=int(l9_409.w*255.0);
float l9_421=packValue(l9_420);
sc_writeFragData0(vec4(packValue(l9_412),packValue(l9_412),packValue(l9_412),packValue(l9_412)));
sc_writeFragData1(vec4(l9_413,packValue(l9_412),packValue(l9_412),packValue(l9_412)));
sc_writeFragData2(vec4(l9_421,packValue(l9_420),packValue(l9_420),packValue(l9_420)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_424=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_424).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_429==0)
{
l9_432=texture2D(sc_OITAlpha0,l9_424);
l9_431=texture2D(sc_OITDepthLow0,l9_424);
l9_430=texture2D(sc_OITDepthHigh0,l9_424);
}
else
{
l9_432=vec4(0.0);
...
if (l9_429==1)
{
l9_435=texture2D(sc_OITAlpha1,l9_424);
l9_434=texture2D(sc_OITDepthLow1,l9_424);
l9_433=texture2D(sc_OITDepthHigh1,l9_424);
}
else
{
l9_435=l9_432;
...
if (any(notEqual(l9_433,vec4(0.0)))||any(notEqual(l9_434,vec4(0.0))))
{
int l9_436[8]=l9_425;
unpackValues(l9_433.w,l9_429,l9_436);
unpackValues(l9_433.z,l9_429,l9_436);
unpackValues(l9_433.y,l9_429,l9_436);
unpackValues(l9_433.x,l9_429,l9_436);
unpackValues(l9_434.w,l9_429,l9_436);
unpackValues(l9_434.z,l9_429,l9_436);
unpackValues(l9_434.y,l9_429,l9_436);
unpackValues(l9_434.x,l9_429,l9_436);
int l9_445[8]=l9_426;
unpackValues(l9_435.w,l9_429,l9_445);
unpackValues(l9_435.z,l9_429,l9_445);
unpackValues(l9_435.y,l9_429,l9_445);
unpackValues(l9_435.x,l9_429,l9_445);
}
l9_429++;
continue;
}
...
vec4 l9_450=texture2D(sc_OITFilteredDepthBoundsTexture,l9_424);
vec2 l9_451=l9_450.xy;
int l9_452;
#if (sc_SkinBonesCount>0)
{
l9_452=encodeDepth(((1.0-l9_450.x)*1000.0)+getDepthOrderingEpsilon(),l9_451);
}
#else
{
l9_452=0;
...
#endif
int l9_453=encodeDepth(viewSpaceDepth(),l9_451);
vec4 l9_454;
l9_454=l9_409*l9_409.w;
vec4 l9_455;
int l9_456=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_456<8)
{
int l9_457=l9_425[l9_456];
int l9_458=l9_453-l9_452;
bool l9_459=l9_457<l9_458;
bool l9_460;
if (l9_459)
{
l9_460=l9_425[l9_456]>0;
}
else
{
l9_460=l9_459;
...
if (l9_460)
{
vec3 l9_461=l9_454.xyz*(1.0-(float(l9_426[l9_456])/255.0));
l9_455=vec4(l9_461.x,l9_461.y,l9_461.z,l9_454.w);
}
else
{
l9_455=l9_454;
