...
float l9_473=l9_462;
sc_SoftwareWrapLate(l9_472,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_473);
float l9_474=l9_471.y;
float l9_475=l9_473;
sc_SoftwareWrapLate(l9_474,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_475);
}
#endif
}
#endif
...
#endif
float l9_477=clamp(l9_122,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_477<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_477<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_478=max(l9_121.xyz,vec3(0.0));
vec4 l9_479;
#if (sc_ProjectiveShadowsCaster)
{
l9_479=vec4(l9_478,l9_477);
}
#else
{
l9_479=ngsCalculateLighting(l9_478,l9_477,l9_476,l9_10,l9_11,max(l9_436,vec3(0.0)),0.0,1.0,Port_AO_N036,vec3(1.0));
}
#endif
vec4 l9_480=max(l9_479,vec4(0.0));
if (isProxyMode)
{
vec4 l9_481;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_481,vec4(0.0)));
return;
}
vec4 l9_483;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_485=clamp(l9_480.w*2.0,0.0,1.0);
}
#else
{
float l9_486;
...
{
l9_486=clamp(dot(l9_480.xyz,vec3(l9_480.w)),0.0,1.0);
}
#else
{
float l9_487;
...
#if (sc_BlendMode_Multiply)
{
l9_488=(1.0-dot(l9_480.xyz,vec3(0.33333001)))*l9_480.w;
}
#else
{
float l9_489;
...
{
l9_489=(1.0-clamp(dot(l9_480.xyz,vec3(1.0)),0.0,1.0))*l9_480.w;
}
#else
{
float l9_490;
#if (sc_BlendMode_ColoredGlass)
{
l9_490=clamp(dot(l9_480.xyz,vec3(1.0)),0.0,1.0)*l9_480.w;
}
#else
{
float l9_491;
#if (sc_BlendMode_Add)
{
l9_491=clamp(dot(l9_480.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_492;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_492=clamp(dot(l9_480.xyz,vec3(1.0)),0.0,1.0)*l9_480.w;
}
#else
{
float l9_493;
...
{
l9_493=dot(l9_480.xyz,vec3(0.33333001))*l9_480.w;
}
#else
{
float l9_494;
#if (sc_BlendMode_Min)
{
l9_494=1.0-clamp(dot(l9_480.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_495;
#if (sc_BlendMode_Max)
{
l9_495=clamp(dot(l9_480.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_495=1.0;
...
#endif
l9_483=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_480.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_484);
}
#else
{
vec4 l9_496;
...
{
vec3 l9_498=sc_GetFramebufferColor().xyz;
vec3 l9_499=mix(l9_498,definedBlend(l9_498,l9_480.xyz).xyz,vec3(l9_480.w));
vec4 l9_500=vec4(l9_499.x,l9_499.y,l9_499.z,vec4(0.0).w);
l9_500.w=1.0;
l9_497=l9_500;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_502=l9_480.w;
l9_501=vec4(mix(vec3(1.0),l9_480.xyz,vec3(l9_502)),l9_502);
}
#else
{
vec4 l9_503;
...
{
float l9_504=l9_480.w;
float l9_505;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_505=clamp(l9_504,0.0,1.0);
}
#else
{
l9_505=l9_504;
...
#endif
l9_503=vec4(l9_480.xyz*l9_505,l9_505);
}
#else
{
l9_503=l9_480;
...
{
l9_508=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_508=vec4(0.0);
...
vec4 l9_510=outputMotionVectorsIfNeeded(varPos,max(l9_509,vec4(0.0)));
vec4 l9_511=clamp(l9_510,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_512=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_512-0.0039215689)),min(1.0,l9_512+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_513=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_513).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_514=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_513).xy);
float l9_515=packValue(l9_514);
int l9_522=int(l9_511.w*255.0);
float l9_523=packValue(l9_522);
sc_writeFragData0(vec4(packValue(l9_514),packValue(l9_514),packValue(l9_514),packValue(l9_514)));
sc_writeFragData1(vec4(l9_515,packValue(l9_514),packValue(l9_514),packValue(l9_514)));
sc_writeFragData2(vec4(l9_523,packValue(l9_522),packValue(l9_522),packValue(l9_522)));
...
if (l9_531==0)
{
l9_534=texture(sc_OITAlpha0,l9_526);
l9_533=texture(sc_OITDepthLow0,l9_526);
l9_532=texture(sc_OITDepthHigh0,l9_526);
}
else
{
l9_534=vec4(0.0);
...
if (l9_531==1)
{
l9_537=texture(sc_OITAlpha1,l9_526);
l9_536=texture(sc_OITDepthLow1,l9_526);
l9_535=texture(sc_OITDepthHigh1,l9_526);
}
else
{
l9_537=l9_534;
...
if (any(notEqual(l9_535,vec4(0.0)))||any(notEqual(l9_536,vec4(0.0))))
{
int l9_538[8]=l9_527;
unpackValues(l9_535.w,l9_531,l9_538);
unpackValues(l9_535.z,l9_531,l9_538);
unpackValues(l9_535.y,l9_531,l9_538);
unpackValues(l9_535.x,l9_531,l9_538);
unpackValues(l9_536.w,l9_531,l9_538);
unpackValues(l9_536.z,l9_531,l9_538);
unpackValues(l9_536.y,l9_531,l9_538);
unpackValues(l9_536.x,l9_531,l9_538);
int l9_547[8]=l9_528;
unpackValues(l9_537.w,l9_531,l9_547);
unpackValues(l9_537.z,l9_531,l9_547);
unpackValues(l9_537.y,l9_531,l9_547);
unpackValues(l9_537.x,l9_531,l9_547);
}
l9_531++;
continue;
}
...
vec4 l9_552=texture(sc_OITFilteredDepthBoundsTexture,l9_526);
vec2 l9_553=l9_552.xy;
int l9_554;
#if (sc_SkinBonesCount>0)
{
l9_554=encodeDepth(((1.0-l9_552.x)*1000.0)+getDepthOrderingEpsilon(),l9_553);
}
#else
{
l9_554=0;
...
#endif
int l9_555=encodeDepth(viewSpaceDepth(),l9_553);
vec4 l9_556;
l9_556=l9_511*l9_511.w;
vec4 l9_557;
int l9_558=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_558<8)
{
int l9_559=l9_527[l9_558];
int l9_560=l9_555-l9_554;
bool l9_561=l9_559<l9_560;
bool l9_562;
if (l9_561)
{
l9_562=l9_527[l9_558]>0;
}
else
{
l9_562=l9_561;
...
if (l9_562)
{
vec3 l9_563=l9_556.xyz*(1.0-(float(l9_528[l9_558])/255.0));
l9_557=vec4(l9_563.x,l9_563.y,l9_563.z,l9_556.w);
}
else
{
l9_557=l9_556;
...
sc_writeFragData0(l9_511);
}
#endif
}
#else
{
sc_writeFragData0(l9_510);
}
#endif
}
#endif
