...
//spec_const bool sc_TAAEnabled 75
//spec_const bool sc_UseFramebufferFetchMarker 76
//spec_const bool sc_VertexBlending 77
//spec_const bool sc_VertexBlendingUseNormals 78
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 79
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 81
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82
//spec_const int baseTexLayout 83
//spec_const int intensityTextureLayout 84
//spec_const int sc_DepthBufferMode 85
//spec_const int sc_RenderingSpace 86
//spec_const int sc_ScreenTextureLayout 87
//spec_const int sc_ShaderCacheConstant 88
//spec_const int sc_SkinBonesCount 89
//spec_const int sc_StereoRenderingMode 90
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 91
//spec_const int sc_StereoViewID 92
//SG_REFLECTION_END
...
#endif
float l9_0=float(channel);
vec4 l9_1;
if ((float(l9_0==Port_Input1_N014)*1.0)!=0.0)
{
...
vec4 l9_23=texture2D(baseTex,l9_22.xy,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
l9_1=vec4(l9_24.www,Port_Value4_N023);
}
else
{
vec4 l9_25;
if ((float(l9_0==Port_Input1_N009)*1.0)!=0.0)
{
...
float l9_41=l9_40.x;
float l9_42=l9_31;
sc_SoftwareWrapLate(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_42);
float l9_43=l9_40.y;
float l9_44=l9_42;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_44);
float l9_45=l9_44;
vec3 l9_46=sc_SamplingCoordsViewToGlobal(vec2(l9_41,l9_43),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_47=texture2D(baseTex,l9_46.xy,0.0);
vec4 l9_48;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
l9_25=vec4(l9_48.zzz,Port_Value4_N021);
}
else
{
vec4 l9_49;
if ((float(l9_0==Port_Input1_N008)*1.0)!=0.0)
{
float l9_50=varPackedTex.x;
sc_SoftwareWrapEarly(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_51=l9_50;
float l9_52=varPackedTex.y;
sc_SoftwareWrapEarly(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_53=l9_52;
vec2 l9_54;
float l9_55;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_56=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_57=l9_51;
float l9_58=1.0;
sc_ClampUV(l9_57,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_56,l9_58);
float l9_59=l9_57;
float l9_60=l9_58;
bool l9_61;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_61=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_62=l9_53;
float l9_63=l9_60;
sc_ClampUV(l9_62,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_61,l9_63);
l9_55=l9_63;
...
#endif
vec2 l9_64=sc_TransformUV(l9_54,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_65=l9_64.x;
float l9_66=l9_55;
sc_SoftwareWrapLate(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_66);
float l9_67=l9_64.y;
float l9_68=l9_66;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_68);
float l9_69=l9_68;
vec3 l9_70=sc_SamplingCoordsViewToGlobal(vec2(l9_65,l9_67),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_71=texture2D(baseTex,l9_70.xy,0.0);
vec4 l9_72;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_72=mix(baseTexBorderColor,l9_71,vec4(l9_69));
}
#else
{
l9_72=l9_71;
...
#endif
l9_49=vec4(l9_72.yyy,Port_Value4_N017);
}
else
{
vec4 l9_73;
if ((float(l9_0==Port_Input1_N006)*1.0)!=0.0)
{
float l9_74=varPackedTex.x;
sc_SoftwareWrapEarly(l9_74,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_75=l9_74;
float l9_76=varPackedTex.y;
sc_SoftwareWrapEarly(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_77=l9_76;
vec2 l9_78;
float l9_79;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_80=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_80=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_81=l9_75;
float l9_82=1.0;
sc_ClampUV(l9_81,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_80,l9_82);
float l9_83=l9_81;
float l9_84=l9_82;
bool l9_85;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_85=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_85=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_86=l9_77;
float l9_87=l9_84;
sc_ClampUV(l9_86,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_85,l9_87);
l9_79=l9_87;
...
#endif
vec2 l9_88=sc_TransformUV(l9_78,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_89=l9_88.x;
float l9_90=l9_79;
sc_SoftwareWrapLate(l9_89,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_90);
float l9_91=l9_88.y;
float l9_92=l9_90;
sc_SoftwareWrapLate(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_92);
float l9_93=l9_92;
vec3 l9_94=sc_SamplingCoordsViewToGlobal(vec2(l9_89,l9_91),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_95=texture2D(baseTex,l9_94.xy,0.0);
vec4 l9_96;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_96=mix(baseTexBorderColor,l9_95,vec4(l9_93));
}
#else
{
l9_96=l9_95;
...
#endif
l9_73=vec4(l9_96.xxx,Port_Value4_N016);
}
else
{
vec4 l9_97;
if ((float(l9_0==Port_Input1_N003)*1.0)!=0.0)
{
float l9_98=varPackedTex.x;
sc_SoftwareWrapEarly(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_99=l9_98;
float l9_100=varPackedTex.y;
sc_SoftwareWrapEarly(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_101=l9_100;
vec2 l9_102;
float l9_103;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_104=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_104=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_105=l9_99;
float l9_106=1.0;
sc_ClampUV(l9_105,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_104,l9_106);
float l9_107=l9_105;
float l9_108=l9_106;
bool l9_109;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_109=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_109=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_110=l9_101;
float l9_111=l9_108;
sc_ClampUV(l9_110,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_109,l9_111);
l9_103=l9_111;
...
#endif
vec2 l9_112=sc_TransformUV(l9_102,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_113=l9_112.x;
float l9_114=l9_103;
sc_SoftwareWrapLate(l9_113,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_114);
float l9_115=l9_112.y;
float l9_116=l9_114;
sc_SoftwareWrapLate(l9_115,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_116);
float l9_117=l9_116;
vec3 l9_118=sc_SamplingCoordsViewToGlobal(vec2(l9_113,l9_115),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_119=texture2D(baseTex,l9_118.xy,0.0);
vec4 l9_120;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_120=mix(baseTexBorderColor,l9_119,vec4(l9_117));
}
#else
{
l9_120=l9_119;
...
{
float l9_121=varPackedTex.x;
sc_SoftwareWrapEarly(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_122=l9_121;
float l9_123=varPackedTex.y;
sc_SoftwareWrapEarly(l9_123,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_124=l9_123;
vec2 l9_125;
float l9_126;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_127=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_128=l9_122;
float l9_129=1.0;
sc_ClampUV(l9_128,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_127,l9_129);
float l9_130=l9_128;
float l9_131=l9_129;
bool l9_132;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_132=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_132=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_133=l9_124;
float l9_134=l9_131;
sc_ClampUV(l9_133,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_132,l9_134);
l9_126=l9_134;
...
#endif
vec2 l9_135=sc_TransformUV(l9_125,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_136=l9_135.x;
float l9_137=l9_126;
sc_SoftwareWrapLate(l9_136,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_137);
float l9_138=l9_135.y;
float l9_139=l9_137;
sc_SoftwareWrapLate(l9_138,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_139);
float l9_140=l9_139;
vec3 l9_141=sc_SamplingCoordsViewToGlobal(vec2(l9_136,l9_138),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_142=texture2D(baseTex,l9_141.xy,0.0);
vec4 l9_143;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_143=mix(baseTexBorderColor,l9_142,vec4(l9_140));
}
#else
{
l9_143=l9_142;
...
{
l9_146=clamp(l9_1.w*2.0,0.0,1.0);
}
#else
{
float l9_147;
...
{
l9_147=clamp(dot(l9_1.xyz,vec3(l9_1.w)),0.0,1.0);
}
#else
{
float l9_148;
...
{
l9_149=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*l9_1.w;
}
#else
{
float l9_150;
...
{
l9_150=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*l9_1.w;
}
#else
{
float l9_151;
...
{
l9_151=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_152;
#if (sc_BlendMode_Add)
{
l9_152=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_153;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_153=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_154;
...
{
l9_154=dot(l9_1.xyz,vec3(0.33333001))*l9_1.w;
}
#else
{
float l9_155;
#if (sc_BlendMode_Min)
{
l9_155=1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_156;
#if (sc_BlendMode_Max)
{
l9_156=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_156=1.0;
...
#endif
l9_144=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_1.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_145);
}
#else
{
vec4 l9_157;
...
#if (sc_FramebufferFetch)
{
vec4 l9_160=sc_readFragData0_Platform();
vec4 l9_161;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_162=l9_160;
l9_162.x=l9_160.x+_sc_framebufferFetchMarker;
l9_161=l9_162;
}
#else
{
...
{
l9_164=1-sc_GetStereoViewIndex();
}
#else
{
l9_164=sc_GetStereoViewIndex();
}
#endif
l9_159=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_163,sc_ScreenTextureLayout,l9_164).xy,0.0);
}
#endif
vec4 l9_165;
...
{
vec4 l9_166=l9_159;
l9_166.x=l9_159.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_165=l9_166;
}
#else
{
...
#endif
vec3 l9_167=mix(l9_165.xyz,definedBlend(l9_165.xyz,l9_1.xyz).xyz,vec3(l9_1.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_169=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_1.w)),l9_1.w);
}
#else
{
vec4 l9_170;
...
#endif
l9_170=vec4(l9_1.xyz*l9_171,l9_171);
}
#else
{
l9_170=l9_1;
...
{
l9_174=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_174=vec4(0.0);
...
vec4 l9_176=outputMotionVectorsIfNeeded(varPos,max(l9_175,vec4(0.0)));
vec4 l9_177=clamp(l9_176,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_178=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_178-0.0039215689)),min(1.0,l9_178+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_180=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_179).xy);
float l9_181=packValue(l9_180);
int l9_188=int(l9_177.w*255.0);
float l9_189=packValue(l9_188);
sc_writeFragData0(vec4(packValue(l9_180),packValue(l9_180),packValue(l9_180),packValue(l9_180)));
sc_writeFragData1(vec4(l9_181,packValue(l9_180),packValue(l9_180),packValue(l9_180)));
sc_writeFragData2(vec4(l9_189,packValue(l9_188),packValue(l9_188),packValue(l9_188)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_192).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_197==0)
{
l9_200=texture2D(sc_OITAlpha0,l9_192);
l9_199=texture2D(sc_OITDepthLow0,l9_192);
l9_198=texture2D(sc_OITDepthHigh0,l9_192);
}
else
{
l9_200=vec4(0.0);
...
if (l9_197==1)
{
l9_203=texture2D(sc_OITAlpha1,l9_192);
l9_202=texture2D(sc_OITDepthLow1,l9_192);
l9_201=texture2D(sc_OITDepthHigh1,l9_192);
}
else
{
l9_203=l9_200;
...
if (any(notEqual(l9_201,vec4(0.0)))||any(notEqual(l9_202,vec4(0.0))))
{
int l9_204[8]=l9_193;
unpackValues(l9_201.w,l9_197,l9_204);
unpackValues(l9_201.z,l9_197,l9_204);
unpackValues(l9_201.y,l9_197,l9_204);
unpackValues(l9_201.x,l9_197,l9_204);
unpackValues(l9_202.w,l9_197,l9_204);
unpackValues(l9_202.z,l9_197,l9_204);
unpackValues(l9_202.y,l9_197,l9_204);
unpackValues(l9_202.x,l9_197,l9_204);
int l9_213[8]=l9_194;
unpackValues(l9_203.w,l9_197,l9_213);
unpackValues(l9_203.z,l9_197,l9_213);
unpackValues(l9_203.y,l9_197,l9_213);
unpackValues(l9_203.x,l9_197,l9_213);
}
l9_197++;
continue;
}
...
vec4 l9_218=texture2D(sc_OITFilteredDepthBoundsTexture,l9_192);
vec2 l9_219=l9_218.xy;
int l9_220;
#if (sc_SkinBonesCount>0)
{
l9_220=encodeDepth(((1.0-l9_218.x)*1000.0)+getDepthOrderingEpsilon(),l9_219);
}
#else
{
l9_220=0;
...
#endif
int l9_221=encodeDepth(viewSpaceDepth(),l9_219);
vec4 l9_222;
l9_222=l9_177*l9_177.w;
vec4 l9_223;
int l9_224=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_224<8)
{
int l9_225=l9_193[l9_224];
int l9_226=l9_221-l9_220;
bool l9_227=l9_225<l9_226;
bool l9_228;
if (l9_227)
{
l9_228=l9_193[l9_224]>0;
}
else
{
l9_228=l9_227;
...
if (l9_228)
{
vec3 l9_229=l9_222.xyz*(1.0-(float(l9_194[l9_224])/255.0));
l9_223=vec4(l9_229.x,l9_229.y,l9_229.z,l9_222.w);
}
else
{
l9_223=l9_222;
