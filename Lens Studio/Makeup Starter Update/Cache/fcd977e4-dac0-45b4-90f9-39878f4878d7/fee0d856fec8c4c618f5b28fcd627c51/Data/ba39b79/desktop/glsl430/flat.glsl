...
//spec_const bool SC_DISABLE_FRUSTUM_CULLING 33
//spec_const bool SC_USE_CLAMP_TO_BORDER_baseTex 34
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 35
//spec_const bool SC_USE_CLAMP_TO_BORDER_opacityTex 36
//spec_const bool SC_USE_UV_MIN_MAX_baseTex 37
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 38
//spec_const bool SC_USE_UV_MIN_MAX_opacityTex 39
...
//spec_const bool Tweak_N11 43
//spec_const bool Tweak_N67 44
...
//spec_const bool sc_DepthOnly 65
//spec_const bool sc_FramebufferFetch 66
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 67
//spec_const bool sc_IsEditor 68
...
//spec_const bool sc_OITDepthPrepass 73
//spec_const bool sc_OITFrontLayerPass 74
//spec_const bool sc_OITMaxLayers4Plus1 75
//spec_const bool sc_OITMaxLayers8 76
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 77
//spec_const bool sc_ProjectiveShadowsCaster 78
//spec_const bool sc_ProjectiveShadowsReceiver 79
//spec_const bool sc_ProxyAlphaOne 80
//spec_const bool sc_RenderAlphaToColor 81
//spec_const bool sc_ScreenTextureHasSwappedViews 82
//spec_const bool sc_ShaderComplexityAnalyzer 83
//spec_const bool sc_TAAEnabled 84
//spec_const bool sc_UseFramebufferFetchMarker 85
//spec_const bool sc_VertexBlending 86
//spec_const bool sc_VertexBlendingUseNormals 87
//spec_const bool uv2EnableAnimation 88
//spec_const bool uv3EnableAnimation 89
//spec_const int NODE_13_DROPLIST_ITEM 90
//spec_const int NODE_27_DROPLIST_ITEM 91
//spec_const int NODE_49_DROPLIST_ITEM 92
//spec_const int NODE_69_DROPLIST_ITEM 93
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 94
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 95
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 96
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 97
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 98
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 99
//spec_const int baseTexLayout 100
//spec_const int intensityTextureLayout 101
//spec_const int opacityTexLayout 102
//spec_const int sc_DepthBufferMode 103
//spec_const int sc_RenderingSpace 104
//spec_const int sc_ScreenTextureLayout 105
//spec_const int sc_ShaderCacheConstant 106
//spec_const int sc_SkinBonesCount 107
//spec_const int sc_StereoRenderingMode 108
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 109
//spec_const int sc_StereoViewID 110
//SG_REFLECTION_END
...
float l9_34=l9_33.x;
float l9_35=l9_24;
sc_SoftwareWrapLate(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_35);
float l9_36=l9_33.y;
float l9_37=l9_35;
sc_SoftwareWrapLate(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_37);
float l9_38=l9_37;
...
float l9_57=l9_56.x;
float l9_58=l9_47;
sc_SoftwareWrapLate(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_58);
float l9_59=l9_56.y;
float l9_60=l9_58;
sc_SoftwareWrapLate(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_60);
float l9_61=l9_60;
...
{
vec2 l9_70;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_70,l9_8);
float l9_71;
Node67_Bool_Parameter(l9_71,l9_8);
l9_69=mix(l9_5,l9_70,vec2(l9_71));
}
#else
{
vec2 l9_72;
...
{
vec2 l9_73;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_73,l9_8);
float l9_74;
Node11_Bool_Parameter(l9_74,l9_8);
l9_72=mix(l9_5,l9_73,vec2(l9_74));
}
#else
{
l9_72=l9_5;
...
float l9_91=l9_90.x;
float l9_92=l9_81;
sc_SoftwareWrapLate(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_92);
float l9_93=l9_90.y;
float l9_94=l9_92;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_94);
float l9_95=l9_94;
...
float l9_115=l9_104;
sc_SoftwareWrapLate(l9_114,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_115);
float l9_116=l9_113.y;
float l9_117=l9_115;
sc_SoftwareWrapLate(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_117);
float l9_118=l9_117;
...
#endif
float l9_122=l9_65.w*l9_66;
vec4 l9_123=vec4(l9_65.x,l9_65.y,l9_65.z,vec4(0.0).w);
l9_123.w=l9_122;
#if (sc_BlendMode_AlphaTest)
{
if (l9_122<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_122<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_124,vec4(0.0)));
return;
}
vec4 l9_126;
...
{
l9_128=clamp(l9_122*2.0,0.0,1.0);
}
#else
{
float l9_129;
...
{
l9_129=clamp(dot(l9_123.xyz,vec3(l9_122)),0.0,1.0);
}
#else
{
float l9_130;
...
{
l9_131=(1.0-dot(l9_123.xyz,vec3(0.33333001)))*l9_122;
}
#else
{
float l9_132;
...
{
l9_132=(1.0-clamp(dot(l9_123.xyz,vec3(1.0)),0.0,1.0))*l9_122;
}
#else
{
float l9_133;
...
{
l9_133=clamp(dot(l9_123.xyz,vec3(1.0)),0.0,1.0)*l9_122;
}
#else
{
float l9_134;
#if (sc_BlendMode_Add)
{
l9_134=clamp(dot(l9_123.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_135;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_135=clamp(dot(l9_123.xyz,vec3(1.0)),0.0,1.0)*l9_122;
}
#else
{
float l9_136;
...
{
l9_136=dot(l9_123.xyz,vec3(0.33333001))*l9_122;
}
#else
{
float l9_137;
#if (sc_BlendMode_Min)
{
l9_137=1.0-clamp(dot(l9_123.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_138;
#if (sc_BlendMode_Max)
{
l9_138=clamp(dot(l9_123.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_138=1.0;
...
#endif
l9_126=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_123.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_127);
}
#else
{
vec4 l9_139;
...
#if (sc_FramebufferFetch)
{
vec4 l9_142=sc_readFragData0_Platform();
vec4 l9_143;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_144=l9_142;
l9_144.x=l9_142.x+_sc_framebufferFetchMarker;
l9_143=l9_144;
}
#else
{
...
{
l9_146=1-sc_GetStereoViewIndex();
}
#else
{
l9_146=sc_GetStereoViewIndex();
}
#endif
vec4 l9_147;
#if (sc_ScreenTextureLayout==2)
{
l9_147=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_145,sc_ScreenTextureLayout,l9_146),0.0);
}
#else
{
l9_147=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_145,sc_ScreenTextureLayout,l9_146).xy,0.0);
}
#endif
l9_141=l9_147;
}
...
{
vec4 l9_149=l9_141;
l9_149.x=l9_141.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_148=l9_149;
}
#else
{
...
#endif
vec3 l9_150=mix(l9_148.xyz,definedBlend(l9_148.xyz,l9_123.xyz).xyz,vec3(l9_122));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_152=vec4(mix(vec3(1.0),l9_123.xyz,vec3(l9_122)),l9_122);
}
#else
{
vec4 l9_153;
...
#endif
l9_153=vec4(l9_123.xyz*l9_154,l9_154);
}
#else
{
l9_153=l9_123;
...
{
l9_157=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_157=vec4(0.0);
...
vec4 l9_159=outputMotionVectorsIfNeeded(varPos,max(l9_158,vec4(0.0)));
vec4 l9_160=clamp(l9_159,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_161=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_161-0.0039215689)),min(1.0,l9_161+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_163=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_162).xy);
float l9_164=packValue(l9_163);
int l9_171=int(l9_160.w*255.0);
float l9_172=packValue(l9_171);
sc_writeFragData0(vec4(packValue(l9_163),packValue(l9_163),packValue(l9_163),packValue(l9_163)));
sc_writeFragData1(vec4(l9_164,packValue(l9_163),packValue(l9_163),packValue(l9_163)));
sc_writeFragData2(vec4(l9_172,packValue(l9_171),packValue(l9_171),packValue(l9_171)));
...
if (l9_180==0)
{
l9_183=texture(sc_OITAlpha0,l9_175);
l9_182=texture(sc_OITDepthLow0,l9_175);
l9_181=texture(sc_OITDepthHigh0,l9_175);
}
else
{
l9_183=vec4(0.0);
...
if (l9_180==1)
{
l9_186=texture(sc_OITAlpha1,l9_175);
l9_185=texture(sc_OITDepthLow1,l9_175);
l9_184=texture(sc_OITDepthHigh1,l9_175);
}
else
{
l9_186=l9_183;
...
if (any(notEqual(l9_184,vec4(0.0)))||any(notEqual(l9_185,vec4(0.0))))
{
int l9_187[8]=l9_176;
unpackValues(l9_184.w,l9_180,l9_187);
unpackValues(l9_184.z,l9_180,l9_187);
unpackValues(l9_184.y,l9_180,l9_187);
unpackValues(l9_184.x,l9_180,l9_187);
unpackValues(l9_185.w,l9_180,l9_187);
unpackValues(l9_185.z,l9_180,l9_187);
unpackValues(l9_185.y,l9_180,l9_187);
unpackValues(l9_185.x,l9_180,l9_187);
int l9_196[8]=l9_177;
unpackValues(l9_186.w,l9_180,l9_196);
unpackValues(l9_186.z,l9_180,l9_196);
unpackValues(l9_186.y,l9_180,l9_196);
unpackValues(l9_186.x,l9_180,l9_196);
}
l9_180++;
continue;
}
...
vec4 l9_201=texture(sc_OITFilteredDepthBoundsTexture,l9_175);
vec2 l9_202=l9_201.xy;
int l9_203;
#if (sc_SkinBonesCount>0)
{
l9_203=encodeDepth(((1.0-l9_201.x)*1000.0)+getDepthOrderingEpsilon(),l9_202);
}
#else
{
l9_203=0;
...
#endif
int l9_204=encodeDepth(viewSpaceDepth(),l9_202);
vec4 l9_205;
l9_205=l9_160*l9_160.w;
vec4 l9_206;
int l9_207=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_207<8)
{
int l9_208=l9_176[l9_207];
int l9_209=l9_204-l9_203;
bool l9_210=l9_208<l9_209;
bool l9_211;
if (l9_210)
{
l9_211=l9_176[l9_207]>0;
}
else
{
l9_211=l9_210;
...
if (l9_211)
{
vec3 l9_212=l9_205.xyz*(1.0-(float(l9_177[l9_207])/255.0));
l9_206=vec4(l9_212.x,l9_212.y,l9_212.z,l9_205.w);
}
else
{
l9_206=l9_205;
