...
//spec_const bool sc_CanUseStandardDerivatives 105
//spec_const bool sc_CanUseTextureLod 106
//spec_const bool sc_DepthOnly 107
//spec_const bool sc_EnvmapDiffuseHasSwappedViews 108
//spec_const bool sc_EnvmapSpecularHasSwappedViews 109
//spec_const bool sc_FramebufferFetch 110
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 111
//spec_const bool sc_HasDiffuseEnvmap 112
//spec_const bool sc_IsEditor 113
//spec_const bool sc_LightEstimation 114
//spec_const bool sc_MotionVectorsPass 115
//spec_const bool sc_OITCompositingPass 116
//spec_const bool sc_OITDepthBoundsPass 117
//spec_const bool sc_OITDepthGatherPass 118
//spec_const bool sc_OITDepthPrepass 119
//spec_const bool sc_OITFrontLayerPass 120
//spec_const bool sc_OITMaxLayers4Plus1 121
//spec_const bool sc_OITMaxLayers8 122
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 123
//spec_const bool sc_ProjectiveShadowsCaster 124
//spec_const bool sc_ProjectiveShadowsReceiver 125
//spec_const bool sc_RenderAlphaToColor 126
//spec_const bool sc_SSAOEnabled 127
//spec_const bool sc_ScreenTextureHasSwappedViews 128
//spec_const bool sc_ShaderComplexityAnalyzer 129
//spec_const bool sc_TAAEnabled 130
//spec_const bool sc_UseFramebufferFetchMarker 131
//spec_const bool sc_VertexBlending 132
//spec_const bool sc_VertexBlendingUseNormals 133
//spec_const bool uv2EnableAnimation 134
//spec_const bool uv3EnableAnimation 135
//spec_const int NODE_13_DROPLIST_ITEM 136
//spec_const int NODE_181_DROPLIST_ITEM 137
//spec_const int NODE_184_DROPLIST_ITEM 138
//spec_const int NODE_221_DROPLIST_ITEM 139
//spec_const int NODE_228_DROPLIST_ITEM 140
//spec_const int NODE_27_DROPLIST_ITEM 141
//spec_const int NODE_315_DROPLIST_ITEM 142
//spec_const int NODE_38_DROPLIST_ITEM 143
//spec_const int NODE_49_DROPLIST_ITEM 144
//spec_const int NODE_69_DROPLIST_ITEM 145
//spec_const int NODE_76_DROPLIST_ITEM 146
//spec_const int SC_DEVICE_CLASS 147
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 148
//spec_const int SC_SOFTWARE_WRAP_MODE_U_detailNormalTex 149
//spec_const int SC_SOFTWARE_WRAP_MODE_U_emissiveTex 150
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 151
//spec_const int SC_SOFTWARE_WRAP_MODE_U_materialParamsTex 152
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 153
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 154
//spec_const int SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex 155
//spec_const int SC_SOFTWARE_WRAP_MODE_U_reflectionTex 156
//spec_const int SC_SOFTWARE_WRAP_MODE_U_rimColorTex 157
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 158
//spec_const int SC_SOFTWARE_WRAP_MODE_V_detailNormalTex 159
//spec_const int SC_SOFTWARE_WRAP_MODE_V_emissiveTex 160
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 161
//spec_const int SC_SOFTWARE_WRAP_MODE_V_materialParamsTex 162
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 163
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 164
//spec_const int SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex 165
//spec_const int SC_SOFTWARE_WRAP_MODE_V_reflectionTex 166
//spec_const int SC_SOFTWARE_WRAP_MODE_V_rimColorTex 167
//spec_const int baseTexLayout 168
//spec_const int detailNormalTexLayout 169
//spec_const int emissiveTexLayout 170
//spec_const int intensityTextureLayout 171
//spec_const int materialParamsTexLayout 172
//spec_const int normalTexLayout 173
//spec_const int opacityTexLayout 174
//spec_const int reflectionModulationTexLayout 175
//spec_const int reflectionTexLayout 176
//spec_const int rimColorTexLayout 177
//spec_const int sc_AmbientLightMode0 178
//spec_const int sc_AmbientLightMode1 179
//spec_const int sc_AmbientLightMode2 180
//spec_const int sc_AmbientLightMode_Constant 181
//spec_const int sc_AmbientLightMode_EnvironmentMap 182
//spec_const int sc_AmbientLightMode_FromCamera 183
//spec_const int sc_AmbientLightMode_SphericalHarmonics 184
//spec_const int sc_AmbientLightsCount 185
//spec_const int sc_DepthBufferMode 186
//spec_const int sc_DirectionalLightsCount 187
//spec_const int sc_EnvLightMode 188
//spec_const int sc_EnvmapDiffuseLayout 189
//spec_const int sc_EnvmapSpecularLayout 190
//spec_const int sc_LightEstimationSGCount 191
//spec_const int sc_MaxTextureImageUnits 192
//spec_const int sc_PointLightsCount 193
//spec_const int sc_RenderingSpace 194
//spec_const int sc_ScreenTextureLayout 195
//spec_const int sc_ShaderCacheConstant 196
//spec_const int sc_SkinBonesCount 197
//spec_const int sc_StereoRenderingMode 198
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 199
//spec_const int sc_StereoViewID 200
//SG_REFLECTION_END
...
{
vec2 l9_244=N7_getUV(NODE_221_DROPLIST_ITEM);
int l9_245;
...
#endif
float l9_246=l9_244.x;
sc_SoftwareWrapEarly(l9_246,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_247=l9_246;
float l9_248=l9_244.y;
sc_SoftwareWrapEarly(l9_248,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_249=l9_248;
vec2 l9_250;
float l9_251;
...
{
l9_252=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
...
float l9_253=l9_247;
float l9_254=1.0;
sc_ClampUV(l9_253,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_252,l9_254);
float l9_255=l9_253;
float l9_256=l9_254;
bool l9_257;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_257=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_258=l9_249;
float l9_259=l9_256;
sc_ClampUV(l9_258,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_257,l9_259);
l9_251=l9_259;
...
#endif
vec2 l9_260=sc_TransformUV(l9_250,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_261=l9_260.x;
float l9_262=l9_251;
sc_SoftwareWrapLate(l9_261,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_262);
float l9_263=l9_260.y;
float l9_264=l9_262;
sc_SoftwareWrapLate(l9_263,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_264);
float l9_265=l9_264;
vec3 l9_266=sc_SamplingCoordsViewToGlobal(vec2(l9_261,l9_263),materialParamsTexLayout,l9_245);
vec4 l9_267=texture2D(materialParamsTex,l9_266.xy,0.0);
vec4 l9_268;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_268=mix(materialParamsTexBorderColor,l9_267,vec4(l9_265));
}
#else
{
l9_268=l9_267;
...
#endif
l9_243=roughness*l9_268.y;
l9_242=l9_240*l9_268.z;
l9_241=metallic*l9_268.x;
}
#else
{
l9_243=roughness;
...
{
vec3 l9_270=mix(vec3(0.039999999),l9_62.xyz*l9_241,vec3(l9_241));
l9_269=mix(vec3(1.0),mix((l9_270*(1.0-specularAoDarkening))*l9_270,vec3(1.0),vec3(l9_242.x)),vec3(specularAoIntensity));
}
#else
{
l9_269=vec3(1.0);
...
#endif
float l9_273=clamp(l9_63,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_273<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_273<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_274=max(l9_62.xyz,vec3(0.0));
vec4 l9_275;
#if (sc_ProjectiveShadowsCaster)
{
l9_275=vec4(l9_274,l9_273);
}
#else
{
float l9_276=clamp(l9_241,0.0,1.0);
float l9_277=clamp(l9_243,0.0,1.0);
vec3 l9_278=clamp(l9_242,vec3(0.0),vec3(1.0));
vec3 l9_279=clamp(l9_271,vec3(0.0),vec3(1.0));
vec3 l9_280=ssSRGB_to_Linear(l9_274);
vec3 l9_281=normalize(l9_272);
vec3 l9_282=ssSRGB_to_Linear(max(l9_239,vec3(0.0)));
vec3 l9_283;
#if (sc_SSAOEnabled)
{
l9_283=evaluateSSAO(varPos);
}
#else
{
l9_283=l9_278;
...
#endif
vec3 l9_284=vec3(l9_276);
vec3 l9_285=mix(vec3(0.039999999),l9_280*l9_276,l9_284);
vec3 l9_286=mix(l9_280*(1.0-l9_276),vec3(0.0),l9_284);
SurfaceProperties l9_287=SurfaceProperties(l9_286,l9_273,l9_281,varPos,l9_6,l9_276,l9_277,l9_282,l9_283,l9_279,vec3(1.0),l9_285);
vec4 l9_288=vec4(1.0);
vec3 l9_289;
vec3 l9_290;
vec3 l9_291;
vec3 l9_292;
...
l9_297=vec3(0.0);
l9_296=vec3(0.0);
LightingComponents l9_303;
LightProperties l9_304;
SurfaceProperties l9_305;
vec3 l9_306;
int l9_307=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_307<sc_DirectionalLightsCount)
{
LightingComponents l9_308=accumulateLight(LightingComponents(l9_296,l9_297,l9_302,l9_301,l9_299,l9_298),LightProperties(sc_DirectionalLights[l9_307].direction,sc_DirectionalLights[l9_307].color.xyz,sc_DirectionalLights[l9_307].color.w*l9_288[(l9_300<3) ? l9_300 : 3]),l9_287,l9_6);
l9_302=l9_308.indirectDiffuse;
l9_301=l9_308.indirectSpecular;
l9_300++;
l9_299=l9_308.emitted;
l9_298=l9_308.transmitted;
l9_297=l9_308.directSpecular;
l9_296=l9_308.directDiffuse;
l9_307++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_325<sc_PointLightsCount)
{
vec3 l9_327=sc_PointLights[l9_325].position-varPos;
vec3 l9_328=normalize(l9_327);
float l9_329=l9_288[(l9_326<3) ? l9_326 : 3];
float l9_330=clamp((dot(l9_328,sc_PointLights[l9_325].direction)*sc_PointLights[l9_325].angleScale)+sc_PointLights[l9_325].angleOffset,0.0,1.0);
float l9_331=(sc_PointLights[l9_325].color.w*l9_329)*(l9_330*l9_330);
float l9_332;
if (sc_PointLights[l9_325].falloffEnabled)
{
l9_332=l9_331*computeDistanceAttenuation(length(l9_327),sc_PointLights[l9_325].falloffEndDistance);
}
else
{
l9_332=l9_331;
...
l9_318=l9_326+1;
LightingComponents l9_333=accumulateLight(LightingComponents(l9_312,l9_313,l9_317,l9_316,l9_315,l9_314),LightProperties(l9_328,sc_PointLights[l9_325].color.xyz,l9_332),l9_287,l9_6);
l9_319=l9_333.directDiffuse;
l9_320=l9_333.directSpecular;
l9_321=l9_333.indirectDiffuse;
l9_322=l9_333.indirectSpecular;
l9_323=l9_333.emitted;
l9_324=l9_333.transmitted;
l9_317=l9_321;
l9_316=l9_322;
l9_326=l9_318;
l9_315=l9_323;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_337=abs(varShadowTex-vec2(0.5));
vec4 l9_338=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_337.x,l9_337.y),0.5);
l9_336=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_338.xyz,vec3(sc_ShadowColor.w)),vec3(l9_338.w*sc_ShadowDensity));
}
#else
{
l9_336=vec3(1.0);
...
#endif
l9_335=l9_309*l9_336;
l9_334=l9_310*l9_336;
}
#else
{
l9_335=l9_309;
...
{
vec2 l9_340=calcPanoramicTexCoordsFromDir(l9_281,sc_EnvmapRotation.y);
vec4 l9_341;
...
#endif
l9_339=(l9_341.xyz*(1.0/l9_341.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_346;
...
{
l9_352=l9_339+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_353=l9_339;
l9_353.x=l9_339.x+(1e-06*sc_AmbientLights[0].color.x);
l9_352=l9_353;
}
#endif
l9_351=l9_352;
...
{
float l9_364=dot(sc_LightEstimationData.sg[l9_363].axis,l9_281);
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_375=clamp(pow(l9_277,0.66666669),0.0,1.0)*5.0;
vec2 l9_376=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_281,reflect(-l9_6,l9_281),l9_277),sc_EnvmapRotation.y);
vec4 l9_377;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_378=floor(l9_375);
float l9_379=ceil(l9_375);
l9_377=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_376,sc_EnvmapSpecularSize.xy,l9_378),sc_EnvmapSpecularGetStereoViewIndex(),l9_378),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_376,sc_EnvmapSpecularSize.xy,l9_379),sc_EnvmapSpecularGetStereoViewIndex(),l9_379),vec4(l9_375-l9_378));
}
#else
{
l9_377=sc_EnvmapSpecularSampleViewIndexLevel(l9_376,sc_EnvmapSpecularGetStereoViewIndex(),l9_375);
}
#endif
l9_374=vec3(0.0)+((((l9_377.xyz*(1.0/l9_377.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_287,abs(dot(l9_281,l9_6))));
}
#else
{
l9_374=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_381=clamp(l9_277*l9_277,0.0099999998,1.0);
vec3 l9_382;
l9_382=sc_LightEstimationData.ambientLight*l9_285;
int l9_383=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_383<sc_LightEstimationSGCount)
{
float l9_384=l9_381*l9_381;
vec3 l9_385=reflect(-l9_6,l9_281);
float l9_386=dot(l9_281,l9_6);
float l9_387=(2.0/l9_384)/(4.0*max(l9_386,9.9999997e-05));
float l9_388=length((l9_385*l9_387)+(sc_LightEstimationData.sg[l9_383].axis*sc_LightEstimationData.sg[l9_383].sharpness));
float l9_389=clamp(dot(l9_281,l9_385),0.0,1.0);
float l9_390=clamp(l9_386,0.0,1.0);
float l9_391=1.0-l9_384;
l9_382+=((((((((vec3(1.0/(3.1415927*l9_384))*exp((l9_388-l9_387)-sc_LightEstimationData.sg[l9_383].sharpness))*sc_LightEstimationData.sg[l9_383].color)*6.2831855)*(1.0-exp((-2.0)*l9_388)))/vec3(l9_388))*((1.0/(l9_389+sqrt(l9_384+((l9_391*l9_389)*l9_389))))*(1.0/(l9_390+sqrt(l9_384+((l9_391*l9_390)*l9_390))))))*(l9_285+((vec3(1.0)-l9_285)*pow(1.0-clamp(dot(l9_385,normalize(l9_385+l9_6)),0.0,1.0),5.0))))*l9_389);
l9_383++;
continue;
}
else
...
l9_395=vec3(0.0);
l9_394=vec3(0.0);
l9_393=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_286,vec3(l9_273));
l9_392=1.0;
}
#else
{
...
#endif
vec3 l9_397=l9_394*l9_283;
vec3 l9_398=l9_395+l9_397;
vec3 l9_399=l9_286*l9_398;
vec3 l9_400=l9_380*l9_279;
vec3 l9_401=l9_334+l9_400;
vec3 l9_402;
if (l9_396)
{
l9_402=l9_399*srgbToLinear(l9_392);
}
else
{
l9_402=l9_399;
}
vec3 l9_403=l9_402+l9_401;
vec3 l9_404=(l9_403+l9_282)+l9_393;
float l9_405=l9_404.x;
vec4 l9_406=vec4(l9_405,l9_404.yz,l9_392);
vec4 l9_407;
#if (sc_IsEditor)
{
vec4 l9_408=l9_406;
l9_408.x=l9_405+((l9_283.x*l9_279.x)*9.9999997e-06);
l9_407=l9_408;
}
#else
{
...
{
vec3 l9_410=l9_407.xyz*1.8;
vec3 l9_411=(l9_407.xyz*(l9_410+vec3(1.4)))/((l9_407.xyz*(l9_410+vec3(0.5)))+vec3(1.5));
l9_409=vec4(l9_411.x,l9_411.y,l9_411.z,l9_407.w);
}
#else
{
l9_409=l9_407;
...
#endif
vec3 l9_412=vec3(linearToSrgb(l9_409.x),linearToSrgb(l9_409.y),linearToSrgb(l9_409.z));
l9_275=vec4(l9_412.x,l9_412.y,l9_412.z,l9_409.w);
}
#endif
vec4 l9_413=max(l9_275,vec4(0.0));
vec4 l9_414;
#if (sc_ProjectiveShadowsCaster)
{
float l9_415;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_416=clamp(l9_413.w*2.0,0.0,1.0);
}
#else
{
float l9_417;
...
{
l9_417=clamp(dot(l9_413.xyz,vec3(l9_413.w)),0.0,1.0);
}
#else
{
float l9_418;
...
#if (sc_BlendMode_Multiply)
{
l9_419=(1.0-dot(l9_413.xyz,vec3(0.33333001)))*l9_413.w;
}
#else
{
float l9_420;
...
{
l9_420=(1.0-clamp(dot(l9_413.xyz,vec3(1.0)),0.0,1.0))*l9_413.w;
}
#else
{
float l9_421;
#if (sc_BlendMode_ColoredGlass)
{
l9_421=clamp(dot(l9_413.xyz,vec3(1.0)),0.0,1.0)*l9_413.w;
}
#else
{
float l9_422;
#if (sc_BlendMode_Add)
{
l9_422=clamp(dot(l9_413.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_423;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_423=clamp(dot(l9_413.xyz,vec3(1.0)),0.0,1.0)*l9_413.w;
}
#else
{
float l9_424;
...
{
l9_424=dot(l9_413.xyz,vec3(0.33333001))*l9_413.w;
}
#else
{
float l9_425;
#if (sc_BlendMode_Min)
{
l9_425=1.0-clamp(dot(l9_413.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_426;
#if (sc_BlendMode_Max)
{
l9_426=clamp(dot(l9_413.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_426=1.0;
...
#endif
l9_414=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_413.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_415);
}
#else
{
vec4 l9_427;
...
{
vec3 l9_429=sc_GetFramebufferColor().xyz;
vec3 l9_430=mix(l9_429,definedBlend(l9_429,l9_413.xyz).xyz,vec3(l9_413.w));
vec4 l9_431=vec4(l9_430.x,l9_430.y,l9_430.z,vec4(0.0).w);
l9_431.w=1.0;
l9_428=l9_431;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_433=l9_413.w;
l9_432=vec4(mix(vec3(1.0),l9_413.xyz,vec3(l9_433)),l9_433);
}
#else
{
vec4 l9_434;
...
{
float l9_435=l9_413.w;
float l9_436;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_436=clamp(l9_435,0.0,1.0);
}
#else
{
l9_436=l9_435;
...
#endif
l9_434=vec4(l9_413.xyz*l9_436,l9_436);
}
#else
{
l9_434=l9_413;
...
{
l9_439=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_439=vec4(0.0);
...
vec4 l9_441=outputMotionVectorsIfNeeded(varPos,max(l9_440,vec4(0.0)));
vec4 l9_442=clamp(l9_441,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_443=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_443-0.0039215689)),min(1.0,l9_443+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_444=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_444).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_445=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_444).xy);
float l9_446=packValue(l9_445);
int l9_453=int(l9_442.w*255.0);
float l9_454=packValue(l9_453);
sc_writeFragData0(vec4(packValue(l9_445),packValue(l9_445),packValue(l9_445),packValue(l9_445)));
sc_writeFragData1(vec4(l9_446,packValue(l9_445),packValue(l9_445),packValue(l9_445)));
sc_writeFragData2(vec4(l9_454,packValue(l9_453),packValue(l9_453),packValue(l9_453)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_457=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_457).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_462==0)
{
l9_465=texture2D(sc_OITAlpha0,l9_457);
l9_464=texture2D(sc_OITDepthLow0,l9_457);
l9_463=texture2D(sc_OITDepthHigh0,l9_457);
}
else
{
l9_465=vec4(0.0);
...
if (l9_462==1)
{
l9_468=texture2D(sc_OITAlpha1,l9_457);
l9_467=texture2D(sc_OITDepthLow1,l9_457);
l9_466=texture2D(sc_OITDepthHigh1,l9_457);
}
else
{
l9_468=l9_465;
...
if (any(notEqual(l9_466,vec4(0.0)))||any(notEqual(l9_467,vec4(0.0))))
{
int l9_469[8]=l9_458;
unpackValues(l9_466.w,l9_462,l9_469);
unpackValues(l9_466.z,l9_462,l9_469);
unpackValues(l9_466.y,l9_462,l9_469);
unpackValues(l9_466.x,l9_462,l9_469);
unpackValues(l9_467.w,l9_462,l9_469);
unpackValues(l9_467.z,l9_462,l9_469);
unpackValues(l9_467.y,l9_462,l9_469);
unpackValues(l9_467.x,l9_462,l9_469);
int l9_478[8]=l9_459;
unpackValues(l9_468.w,l9_462,l9_478);
unpackValues(l9_468.z,l9_462,l9_478);
unpackValues(l9_468.y,l9_462,l9_478);
unpackValues(l9_468.x,l9_462,l9_478);
}
l9_462++;
continue;
}
...
vec4 l9_483=texture2D(sc_OITFilteredDepthBoundsTexture,l9_457);
vec2 l9_484=l9_483.xy;
int l9_485;
#if (sc_SkinBonesCount>0)
{
l9_485=encodeDepth(((1.0-l9_483.x)*1000.0)+getDepthOrderingEpsilon(),l9_484);
}
#else
{
l9_485=0;
...
#endif
int l9_486=encodeDepth(viewSpaceDepth(),l9_484);
vec4 l9_487;
l9_487=l9_442*l9_442.w;
vec4 l9_488;
int l9_489=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_489<8)
{
int l9_490=l9_458[l9_489];
int l9_491=l9_486-l9_485;
bool l9_492=l9_490<l9_491;
bool l9_493;
if (l9_492)
{
l9_493=l9_458[l9_489]>0;
}
else
{
l9_493=l9_492;
...
if (l9_493)
{
vec3 l9_494=l9_487.xyz*(1.0-(float(l9_459[l9_489])/255.0));
l9_488=vec4(l9_494.x,l9_494.y,l9_494.z,l9_487.w);
}
else
{
l9_488=l9_487;
...
sc_writeFragData0(l9_442);
}
#endif
}
#else
{
sc_writeFragData0(l9_441);
}
#endif
}
#endif
