...
//spec_const bool sc_ProxyAlphaOne 78
//spec_const bool sc_RenderAlphaToColor 79
//spec_const bool sc_ScreenTextureHasSwappedViews 80
//spec_const bool sc_ShaderComplexityAnalyzer 81
//spec_const bool sc_TAAEnabled 82
//spec_const bool sc_UseFramebufferFetchMarker 83
//spec_const bool sc_VertexBlending 84
//spec_const bool sc_VertexBlendingUseNormals 85
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 86
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 87
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 88
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 89
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 90
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 91
//spec_const int baseTexLayout 92
//spec_const int intensityTextureLayout 93
//spec_const int opacityTexLayout 94
//spec_const int sc_DepthBufferMode 95
//spec_const int sc_RenderingSpace 96
//spec_const int sc_ScreenTextureLayout 97
//spec_const int sc_ShaderCacheConstant 98
//spec_const int sc_SkinBonesCount 99
//spec_const int sc_StereoRenderingMode 100
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 101
//spec_const int sc_StereoViewID 102
//SG_REFLECTION_END
...
{
float l9_52=l9_0.x;
sc_SoftwareWrapEarly(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_53=l9_52;
float l9_54=l9_0.y;
sc_SoftwareWrapEarly(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_55=l9_54;
vec2 l9_56;
float l9_57;
...
{
l9_58=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_58=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_59=l9_53;
float l9_60=1.0;
sc_ClampUV(l9_59,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_58,l9_60);
float l9_61=l9_59;
float l9_62=l9_60;
bool l9_63;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_63=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_63=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_64=l9_55;
float l9_65=l9_62;
sc_ClampUV(l9_64,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_63,l9_65);
l9_57=l9_65;
...
#endif
vec2 l9_66=sc_TransformUV(l9_56,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_67=l9_66.x;
float l9_68=l9_57;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_68);
float l9_69=l9_66.y;
float l9_70=l9_68;
sc_SoftwareWrapLate(l9_69,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_70);
float l9_71=l9_70;
vec3 l9_72=sc_SamplingCoordsViewToGlobal(vec2(l9_67,l9_69),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_73=texture(opacityTexArrSC,l9_72,0.0);
vec4 l9_74;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_74=mix(opacityTexBorderColor,l9_73,vec4(l9_71));
}
#else
{
l9_74=l9_73;
...
float l9_90=l9_89.x;
float l9_91=l9_80;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_91);
float l9_92=l9_89.y;
float l9_93=l9_91;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_93);
float l9_94=l9_93;
vec3 l9_95=sc_SamplingCoordsViewToGlobal(vec2(l9_90,l9_92),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_96=texture(opacityTex,l9_95.xy,0.0);
vec4 l9_97;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#endif
vec4 l9_98=vec4(l9_2.x,l9_2.y,l9_2.z,vec4(0.0).w);
l9_98.w=l9_50.x;
vec4 l9_99=baseColor*l9_98;
float l9_100=l9_99.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_100<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_100<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_101,vec4(0.0)));
return;
}
vec4 l9_103;
...
{
l9_105=clamp(l9_100*2.0,0.0,1.0);
}
#else
{
float l9_106;
...
{
l9_106=clamp(dot(l9_99.xyz,vec3(l9_100)),0.0,1.0);
}
#else
{
float l9_107;
...
{
l9_108=(1.0-dot(l9_99.xyz,vec3(0.33333001)))*l9_100;
}
#else
{
float l9_109;
...
{
l9_109=(1.0-clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0))*l9_100;
}
#else
{
float l9_110;
...
{
l9_110=clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0)*l9_100;
}
#else
{
float l9_111;
#if (sc_BlendMode_Add)
{
l9_111=clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_112;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_112=clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0)*l9_100;
}
#else
{
float l9_113;
...
{
l9_113=dot(l9_99.xyz,vec3(0.33333001))*l9_100;
}
#else
{
float l9_114;
#if (sc_BlendMode_Min)
{
l9_114=1.0-clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_115;
#if (sc_BlendMode_Max)
{
l9_115=clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_115=1.0;
...
#endif
l9_103=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_99.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_104);
}
#else
{
vec4 l9_116;
...
#if (sc_FramebufferFetch)
{
vec4 l9_119=sc_readFragData0_Platform();
vec4 l9_120;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_121=l9_119;
l9_121.x=l9_119.x+_sc_framebufferFetchMarker;
l9_120=l9_121;
}
#else
{
...
#else
{
vec2 l9_122=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_123;
...
{
l9_124=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_122,sc_ScreenTextureLayout,l9_123),0.0);
}
#else
{
l9_124=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_122,sc_ScreenTextureLayout,l9_123).xy,0.0);
}
#endif
l9_118=l9_124;
}
...
{
vec4 l9_126=l9_118;
l9_126.x=l9_118.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_125=l9_126;
}
#else
{
...
#endif
vec3 l9_127=mix(l9_125.xyz,definedBlend(l9_125.xyz,l9_99.xyz).xyz,vec3(l9_100));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_129=vec4(mix(vec3(1.0),l9_99.xyz,vec3(l9_100)),l9_100);
}
#else
{
vec4 l9_130;
...
#endif
l9_130=vec4(l9_99.xyz*l9_131,l9_131);
}
#else
{
l9_130=l9_99;
...
{
l9_134=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_134=vec4(0.0);
...
vec4 l9_136=outputMotionVectorsIfNeeded(varPos,max(l9_135,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_138-0.0039215689)),min(1.0,l9_138+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_140),packValue(l9_140),packValue(l9_140),packValue(l9_140)));
