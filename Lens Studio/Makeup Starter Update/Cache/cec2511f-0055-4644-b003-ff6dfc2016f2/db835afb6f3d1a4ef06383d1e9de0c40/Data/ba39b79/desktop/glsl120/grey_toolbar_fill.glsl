...
//spec_const bool NOMASK 31
//spec_const bool NOTEXTURE 32
...
//spec_const bool UseViewSpaceDepthVariant 43
//spec_const bool baseTexHasSwappedViews 44
//spec_const bool intensityTextureHasSwappedViews 45
//spec_const bool opacityTexHasSwappedViews 46
//spec_const bool sc_BlendMode_Add 47
//spec_const bool sc_BlendMode_AddWithAlphaFactor 48
//spec_const bool sc_BlendMode_AlphaTest 49
//spec_const bool sc_BlendMode_AlphaToCoverage 50
//spec_const bool sc_BlendMode_ColoredGlass 51
//spec_const bool sc_BlendMode_Custom 52
//spec_const bool sc_BlendMode_Max 53
//spec_const bool sc_BlendMode_Min 54
//spec_const bool sc_BlendMode_Multiply 55
//spec_const bool sc_BlendMode_MultiplyOriginal 56
//spec_const bool sc_BlendMode_Normal 57
...
//spec_const bool sc_BlendMode_Screen 61
//spec_const bool sc_BlendMode_Software 62
//spec_const bool sc_DepthOnly 63
//spec_const bool sc_FramebufferFetch 64
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 65
//spec_const bool sc_IsEditor 66
//spec_const bool sc_MotionVectorsPass 67
//spec_const bool sc_OITCompositingPass 68
//spec_const bool sc_OITDepthBoundsPass 69
//spec_const bool sc_OITDepthGatherPass 70
//spec_const bool sc_OITDepthPrepass 71
//spec_const bool sc_OITFrontLayerPass 72
//spec_const bool sc_OITMaxLayers4Plus1 73
//spec_const bool sc_OITMaxLayers8 74
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 75
//spec_const bool sc_ProjectiveShadowsCaster 76
//spec_const bool sc_ProjectiveShadowsReceiver 77
//spec_const bool sc_RenderAlphaToColor 78
//spec_const bool sc_ScreenTextureHasSwappedViews 79
//spec_const bool sc_ShaderComplexityAnalyzer 80
//spec_const bool sc_TAAEnabled 81
//spec_const bool sc_UseFramebufferFetchMarker 82
//spec_const bool sc_VertexBlending 83
//spec_const bool sc_VertexBlendingUseNormals 84
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 85
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 86
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 87
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 88
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 89
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 90
//spec_const int baseTexLayout 91
//spec_const int intensityTextureLayout 92
//spec_const int opacityTexLayout 93
//spec_const int sc_DepthBufferMode 94
//spec_const int sc_RenderingSpace 95
//spec_const int sc_ScreenTextureLayout 96
//spec_const int sc_ShaderCacheConstant 97
//spec_const int sc_SkinBonesCount 98
//spec_const int sc_StereoRenderingMode 99
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 100
//spec_const int sc_StereoViewID 101
//SG_REFLECTION_END
...
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),baseTexLayout,l9_1);
...
float l9_42=l9_41.x;
float l9_43=l9_32;
sc_SoftwareWrapLate(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_43);
float l9_44=l9_41.y;
float l9_45=l9_43;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_45);
float l9_46=l9_45;
vec3 l9_47=sc_SamplingCoordsViewToGlobal(vec2(l9_42,l9_44),opacityTexLayout,l9_26);
vec4 l9_48=texture2D(opacityTex,l9_47.xy,0.0);
vec4 l9_49;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#endif
vec4 l9_50=vec4(l9_0.x,l9_0.y,l9_0.z,vec4(0.0).w);
l9_50.w=l9_25.x;
vec4 l9_51=baseColor*l9_50;
float l9_52=l9_51.w;
...
{
l9_56=clamp(dot(l9_51.xyz,vec3(l9_52)),0.0,1.0);
}
#else
{
float l9_57;
...
{
l9_58=(1.0-dot(l9_51.xyz,vec3(0.33333001)))*l9_52;
}
#else
{
float l9_59;
...
{
l9_59=(1.0-clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0))*l9_52;
}
#else
{
float l9_60;
...
{
l9_60=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0)*l9_52;
}
#else
{
float l9_61;
#if (sc_BlendMode_Add)
{
l9_61=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_62;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_62=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0)*l9_52;
}
#else
{
float l9_63;
...
{
l9_63=dot(l9_51.xyz,vec3(0.33333001))*l9_52;
}
#else
{
float l9_64;
#if (sc_BlendMode_Min)
{
l9_64=1.0-clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_65;
#if (sc_BlendMode_Max)
{
l9_65=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_65=1.0;
...
#endif
l9_53=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_51.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_54);
}
#else
{
vec4 l9_66;
...
#endif
l9_68=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_72,sc_ScreenTextureLayout,l9_73).xy,0.0);
}
#endif
vec4 l9_74;
...
{
vec4 l9_75=l9_68;
l9_75.x=l9_68.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_74=l9_75;
}
#else
{
...
#endif
vec3 l9_76=mix(l9_74.xyz,definedBlend(l9_74.xyz,l9_51.xyz).xyz,vec3(l9_52));
vec4 l9_77=vec4(l9_76.x,l9_76.y,l9_76.z,vec4(0.0).w);
l9_77.w=1.0;
l9_67=l9_77;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_78=vec4(mix(vec3(1.0),l9_51.xyz,vec3(l9_52)),l9_52);
}
#else
{
vec4 l9_79;
...
#endif
l9_79=vec4(l9_51.xyz*l9_80,l9_80);
}
#else
{
l9_79=l9_51;
...
{
l9_83=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_83=vec4(0.0);
...
vec4 l9_85=outputMotionVectorsIfNeeded(varPos,max(l9_84,vec4(0.0)));
vec4 l9_86=clamp(l9_85,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_87=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_87-0.0039215689)),min(1.0,l9_87+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_89=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_88).xy);
float l9_90=packValue(l9_89);
int l9_97=int(l9_86.w*255.0);
float l9_98=packValue(l9_97);
sc_writeFragData0(vec4(packValue(l9_89),packValue(l9_89),packValue(l9_89),packValue(l9_89)));
sc_writeFragData1(vec4(l9_90,packValue(l9_89),packValue(l9_89),packValue(l9_89)));
sc_writeFragData2(vec4(l9_98,packValue(l9_97),packValue(l9_97),packValue(l9_97)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_101).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_106==0)
{
l9_109=texture2D(sc_OITAlpha0,l9_101);
l9_108=texture2D(sc_OITDepthLow0,l9_101);
l9_107=texture2D(sc_OITDepthHigh0,l9_101);
}
else
{
l9_109=vec4(0.0);
...
if (l9_106==1)
{
l9_112=texture2D(sc_OITAlpha1,l9_101);
l9_111=texture2D(sc_OITDepthLow1,l9_101);
l9_110=texture2D(sc_OITDepthHigh1,l9_101);
}
else
{
l9_112=l9_109;
...
if (any(notEqual(l9_110,vec4(0.0)))||any(notEqual(l9_111,vec4(0.0))))
{
int l9_113[8]=l9_102;
unpackValues(l9_110.w,l9_106,l9_113);
unpackValues(l9_110.z,l9_106,l9_113);
unpackValues(l9_110.y,l9_106,l9_113);
unpackValues(l9_110.x,l9_106,l9_113);
unpackValues(l9_111.w,l9_106,l9_113);
unpackValues(l9_111.z,l9_106,l9_113);
unpackValues(l9_111.y,l9_106,l9_113);
unpackValues(l9_111.x,l9_106,l9_113);
int l9_122[8]=l9_103;
unpackValues(l9_112.w,l9_106,l9_122);
unpackValues(l9_112.z,l9_106,l9_122);
unpackValues(l9_112.y,l9_106,l9_122);
unpackValues(l9_112.x,l9_106,l9_122);
}
l9_106++;
continue;
}
...
vec4 l9_127=texture2D(sc_OITFilteredDepthBoundsTexture,l9_101);
vec2 l9_128=l9_127.xy;
int l9_129;
#if (sc_SkinBonesCount>0)
{
l9_129=encodeDepth(((1.0-l9_127.x)*1000.0)+getDepthOrderingEpsilon(),l9_128);
}
#else
{
l9_129=0;
...
#endif
int l9_130=encodeDepth(viewSpaceDepth(),l9_128);
vec4 l9_131;
l9_131=l9_86*l9_86.w;
vec4 l9_132;
int l9_133=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_133<8)
{
int l9_134=l9_102[l9_133];
int l9_135=l9_130-l9_129;
bool l9_136=l9_134<l9_135;
bool l9_137;
if (l9_136)
{
l9_137=l9_102[l9_133]>0;
}
else
{
l9_137=l9_136;
...
if (l9_137)
{
vec3 l9_138=l9_131.xyz*(1.0-(float(l9_103[l9_133])/255.0));
l9_132=vec4(l9_138.x,l9_138.y,l9_138.z,l9_131.w);
}
else
{
l9_132=l9_131;
