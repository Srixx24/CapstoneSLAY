...
//spec_const int sc_DepthBufferMode 78
//spec_const int sc_RenderingSpace 79
//spec_const int sc_ScreenTextureLayout 80
//spec_const int sc_ShaderCacheConstant 81
//spec_const int sc_SkinBonesCount 82
//spec_const int sc_StereoRenderingMode 83
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 84
//spec_const int sc_StereoViewID 85
//SG_REFLECTION_END
...
#endif
vec3 l9_23=mix(l9_21.xyz,definedBlend(l9_21.xyz,baseColor.xyz).xyz,vec3(baseColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_25=vec4(mix(vec3(1.0),baseColor.xyz,vec3(baseColor.w)),baseColor.w);
}
#else
{
vec4 l9_26;
...
{
l9_27=clamp(baseColor.w,0.0,1.0);
}
#else
{
l9_27=baseColor.w;
...
#endif
l9_26=vec4(baseColor.xyz*l9_27,l9_27);
}
#else
{
l9_26=baseColor;
