...
//sampler sampler z_hitIdAndBarycentricSmp 0:34
//sampler sampler z_rayDirectionsSmpSC 0:35
...
//texture utexture2D z_hitIdAndBarycentric 0:21:0:34
//texture texture2D z_rayDirections 0:22:0:35
...
//texture texture2DArray sc_ScreenTextureArrSC 0:42:0:31
...
//spec_const bool sc_ProxyAlphaOne 86
...
//spec_const bool uv2EnableAnimation 94
//spec_const bool uv3EnableAnimation 95
//spec_const int NODE_13_DROPLIST_ITEM 96
//spec_const int NODE_27_DROPLIST_ITEM 97
//spec_const int NODE_38_DROPLIST_ITEM 98
//spec_const int NODE_49_DROPLIST_ITEM 99
//spec_const int NODE_69_DROPLIST_ITEM 100
//spec_const int NODE_76_DROPLIST_ITEM 101
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 102
//spec_const int SC_SOFTWARE_WRAP_MODE_U_emissiveTex 103
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 104
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 105
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 106
//spec_const int SC_SOFTWARE_WRAP_MODE_V_emissiveTex 107
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 108
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 109
//spec_const int baseTexLayout 110
//spec_const int emissiveTexLayout 111
//spec_const int intensityTextureLayout 112
//spec_const int opacityTexLayout 113
//spec_const int sc_DepthBufferMode 114
//spec_const int sc_RenderingSpace 115
//spec_const int sc_ScreenTextureLayout 116
//spec_const int sc_ShaderCacheConstant 117
//spec_const int sc_SkinBonesCount 118
//spec_const int sc_StereoRenderingMode 119
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 120
//spec_const int sc_StereoViewID 121
//SG_REFLECTION_END
...
vec4 l9_8=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_7.positionWS,1.0);
l9_6=l9_7.uv0;
l9_5=l9_7.uv1;
l9_4=l9_7.color;
...
tempGlobals=ssGlobals(l9_1,l9_2,0.0,vec2(0.0),vec2(0.0),l9_6,l9_5,l9_4,l9_3);
...
#if (ENABLE_RECOLOR)
{
vec3 l9_59=((recolorRed*l9_9.x)+(recolorGreen*l9_9.y))+(recolorBlue*l9_9.z);
l9_58=vec4(l9_59.x,l9_59.y,l9_59.z,l9_9.w);
}
#else
{
l9_58=l9_9;
...
{
float l9_63=l9_61.x;
sc_SoftwareWrapEarly(l9_63,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_64=l9_63;
float l9_65=l9_61.y;
sc_SoftwareWrapEarly(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_66=l9_65;
vec2 l9_67;
float l9_68;
...
{
l9_69=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_69=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_70=l9_64;
float l9_71=1.0;
sc_ClampUV(l9_70,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_69,l9_71);
float l9_72=l9_70;
float l9_73=l9_71;
bool l9_74;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_74=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_74=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_75=l9_66;
float l9_76=l9_73;
sc_ClampUV(l9_75,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_74,l9_76);
l9_68=l9_76;
...
#endif
vec2 l9_77=sc_TransformUV(l9_67,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_78=l9_77.x;
float l9_79=l9_68;
sc_SoftwareWrapLate(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_79);
float l9_80=l9_77.y;
float l9_81=l9_79;
sc_SoftwareWrapLate(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_81);
float l9_82=l9_81;
vec3 l9_83=sc_SamplingCoordsViewToGlobal(vec2(l9_78,l9_80),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_84=texture(opacityTexArrSC,l9_83,0.0);
vec4 l9_85;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_85=mix(opacityTexBorderColor,l9_84,vec4(l9_82));
}
#else
{
l9_85=l9_84;
...
float l9_102=l9_91;
sc_SoftwareWrapLate(l9_101,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_102);
float l9_103=l9_100.y;
float l9_104=l9_102;
sc_SoftwareWrapLate(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_104);
float l9_105=l9_104;
...
#endif
float l9_109=l9_60*l9_58.w;
vec4 l9_110;
float l9_111;
#if (NODE_38_DROPLIST_ITEM==1)
{
l9_111=l9_109*tempGlobals.VertexColor.w;
l9_110=l9_58*tempGlobals.VertexColor;
}
#else
{
l9_111=l9_109;
...
#if (ENABLE_EMISSIVE)
{
vec2 l9_113=N7_getUV(NODE_76_DROPLIST_ITEM);
vec4 l9_114;
#if (emissiveTexLayout==2)
{
float l9_115=l9_113.x;
sc_SoftwareWrapEarly(l9_115,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x);
float l9_116=l9_115;
float l9_117=l9_113.y;
sc_SoftwareWrapEarly(l9_117,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y);
float l9_118=l9_117;
vec2 l9_119;
float l9_120;
...
{
l9_121=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x==3;
}
#else
{
l9_121=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_122=l9_116;
float l9_123=1.0;
sc_ClampUV(l9_122,emissiveTexUvMinMax.x,emissiveTexUvMinMax.z,l9_121,l9_123);
float l9_124=l9_122;
float l9_125=l9_123;
bool l9_126;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_126=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y==3;
}
#else
{
l9_126=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_127=l9_118;
float l9_128=l9_125;
sc_ClampUV(l9_127,emissiveTexUvMinMax.y,emissiveTexUvMinMax.w,l9_126,l9_128);
l9_120=l9_128;
...
#endif
vec2 l9_129=sc_TransformUV(l9_119,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform);
float l9_130=l9_129.x;
float l9_131=l9_120;
sc_SoftwareWrapLate(l9_130,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0)),l9_131);
float l9_132=l9_129.y;
float l9_133=l9_131;
sc_SoftwareWrapLate(l9_132,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0)),l9_133);
float l9_134=l9_133;
vec3 l9_135=sc_SamplingCoordsViewToGlobal(vec2(l9_130,l9_132),emissiveTexLayout,emissiveTexGetStereoViewIndex());
vec4 l9_136=texture(emissiveTexArrSC,l9_135,0.0);
vec4 l9_137;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_137=mix(emissiveTexBorderColor,l9_136,vec4(l9_134));
}
#else
{
l9_137=l9_136;
...
sc_SoftwareWrapEarly(l9_138,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x);
float l9_139=l9_138;
float l9_140=l9_113.y;
sc_SoftwareWrapEarly(l9_140,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y);
float l9_141=l9_140;
vec2 l9_142;
float l9_143;
#if (SC_USE_UV_MIN_MAX_emissiveTex)
...
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_144=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x==3;
}
#else
{
l9_144=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_145=l9_139;
float l9_146=1.0;
sc_ClampUV(l9_145,emissiveTexUvMinMax.x,emissiveTexUvMinMax.z,l9_144,l9_146);
float l9_147=l9_145;
float l9_148=l9_146;
bool l9_149;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_149=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y==3;
}
#else
{
l9_149=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_150=l9_141;
float l9_151=l9_148;
sc_ClampUV(l9_150,emissiveTexUvMinMax.y,emissiveTexUvMinMax.w,l9_149,l9_151);
l9_143=l9_151;
...
#endif
vec2 l9_152=sc_TransformUV(l9_142,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform);
float l9_153=l9_152.x;
float l9_154=l9_143;
sc_SoftwareWrapLate(l9_153,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0)),l9_154);
float l9_155=l9_152.y;
float l9_156=l9_154;
sc_SoftwareWrapLate(l9_155,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0)),l9_156);
float l9_157=l9_156;
vec3 l9_158=sc_SamplingCoordsViewToGlobal(vec2(l9_153,l9_155),emissiveTexLayout,emissiveTexGetStereoViewIndex());
vec4 l9_159=texture(emissiveTex,l9_158.xy,0.0);
vec4 l9_160;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_160=mix(emissiveTexBorderColor,l9_159,vec4(l9_157));
}
#else
{
l9_160=l9_159;
...
{
l9_161=l9_112+tempGlobals.VertexColor.xyz;
}
#else
{
l9_161=l9_112;
...
{
l9_162=ssPow((l9_161*emissiveColor)*vec3(emissiveIntensity),vec3(2.2));
}
#else
{
l9_162=l9_161;
...
#endif
vec3 l9_163=l9_110.xyz+ssPow((l9_162+vec3(0.0))+vec3(0.0),vec3(0.45454547));
vec4 l9_164=vec4(l9_163.x,l9_163.y,l9_163.z,vec4(0.0).w);
l9_164.w=l9_111;
#if (sc_BlendMode_AlphaTest)
{
if (l9_111<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_111<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_165,vec4(0.0)));
return;
}
vec4 l9_167;
...
{
l9_169=clamp(l9_111*2.0,0.0,1.0);
}
#else
{
float l9_170;
...
{
l9_170=clamp(dot(l9_164.xyz,vec3(l9_111)),0.0,1.0);
}
#else
{
float l9_171;
...
{
l9_172=(1.0-dot(l9_164.xyz,vec3(0.33333001)))*l9_111;
}
#else
{
float l9_173;
...
{
l9_173=(1.0-clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0))*l9_111;
}
#else
{
float l9_174;
...
{
l9_174=clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0)*l9_111;
}
#else
{
float l9_175;
#if (sc_BlendMode_Add)
{
l9_175=clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_176;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_176=clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0)*l9_111;
}
#else
{
float l9_177;
...
{
l9_177=dot(l9_164.xyz,vec3(0.33333001))*l9_111;
}
#else
{
float l9_178;
#if (sc_BlendMode_Min)
{
l9_178=1.0-clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_179;
#if (sc_BlendMode_Max)
{
l9_179=clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_179=1.0;
...
#endif
l9_167=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_164.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_168);
}
#else
{
vec4 l9_180;
...
#if (sc_FramebufferFetch)
{
vec4 l9_183=sc_readFragData0_Platform();
vec4 l9_184;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_185=l9_183;
l9_185.x=l9_183.x+_sc_framebufferFetchMarker;
l9_184=l9_185;
}
#else
{
...
#else
{
vec2 l9_186=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_187;
#if (sc_ScreenTextureHasSwappedViews)
{
l9_187=1-sc_GetStereoViewIndex();
}
#else
{
l9_187=sc_GetStereoViewIndex();
}
#endif
vec4 l9_188;
#if (sc_ScreenTextureLayout==2)
{
l9_188=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_186,sc_ScreenTextureLayout,l9_187),0.0);
}
#else
{
l9_188=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_186,sc_ScreenTextureLayout,l9_187).xy,0.0);
}
#endif
l9_182=l9_188;
}
...
{
vec4 l9_190=l9_182;
l9_190.x=l9_182.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_189=l9_190;
}
#else
{
...
#endif
vec3 l9_191=mix(l9_189.xyz,definedBlend(l9_189.xyz,l9_164.xyz).xyz,vec3(l9_111));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_193=vec4(mix(vec3(1.0),l9_164.xyz,vec3(l9_111)),l9_111);
}
#else
{
vec4 l9_194;
...
#endif
l9_194=vec4(l9_164.xyz*l9_195,l9_195);
}
#else
{
l9_194=l9_164;
