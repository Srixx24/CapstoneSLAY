...
//spec_const bool SC_USE_UV_MIN_MAX_baseTex 37
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 38
//spec_const bool SC_USE_UV_MIN_MAX_materialParamsTex 39
//spec_const bool SC_USE_UV_MIN_MAX_normalTex 40
//spec_const bool SC_USE_UV_TRANSFORM_baseTex 41
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 42
//spec_const bool SC_USE_UV_TRANSFORM_materialParamsTex 43
//spec_const bool SC_USE_UV_TRANSFORM_normalTex 44
...
//spec_const bool materialParamsTexHasSwappedViews 48
//spec_const bool normalTexHasSwappedViews 49
//spec_const bool sc_BlendMode_Add 50
//spec_const bool sc_BlendMode_AddWithAlphaFactor 51
//spec_const bool sc_BlendMode_AlphaTest 52
//spec_const bool sc_BlendMode_AlphaToCoverage 53
//spec_const bool sc_BlendMode_ColoredGlass 54
//spec_const bool sc_BlendMode_Custom 55
//spec_const bool sc_BlendMode_Max 56
//spec_const bool sc_BlendMode_Min 57
//spec_const bool sc_BlendMode_Multiply 58
//spec_const bool sc_BlendMode_MultiplyOriginal 59
//spec_const bool sc_BlendMode_Normal 60
//spec_const bool sc_BlendMode_PremultipliedAlpha 61
//spec_const bool sc_BlendMode_PremultipliedAlphaAuto 62
//spec_const bool sc_BlendMode_PremultipliedAlphaHardware 63
//spec_const bool sc_BlendMode_Screen 64
//spec_const bool sc_BlendMode_Software 65
//spec_const bool sc_CanUseStandardDerivatives 66
//spec_const bool sc_CanUseTextureLod 67
//spec_const bool sc_DepthOnly 68
//spec_const bool sc_EnvmapDiffuseHasSwappedViews 69
//spec_const bool sc_EnvmapSpecularHasSwappedViews 70
//spec_const bool sc_FramebufferFetch 71
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 72
//spec_const bool sc_HasDiffuseEnvmap 73
//spec_const bool sc_IsEditor 74
//spec_const bool sc_LightEstimation 75
...
//spec_const bool sc_RenderAlphaToColor 87
//spec_const bool sc_SSAOEnabled 88
...
//spec_const int SC_DEVICE_CLASS 95
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 96
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 97
//spec_const int SC_SOFTWARE_WRAP_MODE_U_materialParamsTex 98
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 99
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 100
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 101
//spec_const int SC_SOFTWARE_WRAP_MODE_V_materialParamsTex 102
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 103
//spec_const int baseTexLayout 104
//spec_const int intensityTextureLayout 105
//spec_const int materialParamsTexLayout 106
//spec_const int normalTexLayout 107
//spec_const int sc_AmbientLightMode0 108
//spec_const int sc_AmbientLightMode1 109
//spec_const int sc_AmbientLightMode2 110
//spec_const int sc_AmbientLightMode_Constant 111
//spec_const int sc_AmbientLightMode_EnvironmentMap 112
//spec_const int sc_AmbientLightMode_FromCamera 113
//spec_const int sc_AmbientLightMode_SphericalHarmonics 114
//spec_const int sc_AmbientLightsCount 115
//spec_const int sc_DepthBufferMode 116
//spec_const int sc_DirectionalLightsCount 117
//spec_const int sc_EnvLightMode 118
//spec_const int sc_EnvmapDiffuseLayout 119
//spec_const int sc_EnvmapSpecularLayout 120
//spec_const int sc_LightEstimationSGCount 121
//spec_const int sc_MaxTextureImageUnits 122
//spec_const int sc_PointLightsCount 123
//spec_const int sc_RenderingSpace 124
//spec_const int sc_ScreenTextureLayout 125
//spec_const int sc_ShaderCacheConstant 126
//spec_const int sc_SkinBonesCount 127
//spec_const int sc_StereoRenderingMode 128
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 129
//spec_const int sc_StereoViewID 130
//SG_REFLECTION_END
...
float l9_22=l9_21.x;
float l9_23=l9_12;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_23);
float l9_24=l9_21.y;
float l9_25=l9_23;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_25);
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),baseTexLayout,l9_4);
vec4 l9_28=texture2D(baseTex,l9_27.xy,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
float l9_31=l9_5;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_32=l9_31;
float l9_33=l9_8;
sc_SoftwareWrapEarly(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_34=l9_33;
vec2 l9_35;
float l9_36;
...
{
l9_37=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
...
float l9_38=l9_32;
float l9_39=1.0;
sc_ClampUV(l9_38,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_37,l9_39);
float l9_40=l9_38;
float l9_41=l9_39;
bool l9_42;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_42=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_42=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_43=l9_34;
float l9_44=l9_41;
sc_ClampUV(l9_43,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_42,l9_44);
l9_36=l9_44;
...
#endif
vec2 l9_45=sc_TransformUV(l9_35,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_46=l9_45.x;
float l9_47=l9_36;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_47);
float l9_48=l9_45.y;
float l9_49=l9_47;
sc_SoftwareWrapLate(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_49);
float l9_50=l9_49;
vec3 l9_51=sc_SamplingCoordsViewToGlobal(vec2(l9_46,l9_48),normalTexLayout,l9_30);
vec4 l9_52=texture2D(normalTex,l9_51.xy,0.0);
vec4 l9_53;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_53=mix(normalTexBorderColor,l9_52,vec4(l9_50));
}
#else
{
l9_53=l9_52;
...
#endif
float l9_55=l9_5;
sc_SoftwareWrapEarly(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_56=l9_55;
float l9_57=l9_8;
sc_SoftwareWrapEarly(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_58=l9_57;
vec2 l9_59;
float l9_60;
...
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_61=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_62=l9_56;
float l9_63=1.0;
sc_ClampUV(l9_62,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_61,l9_63);
float l9_64=l9_62;
float l9_65=l9_63;
bool l9_66;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_66=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_66=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_67=l9_58;
float l9_68=l9_65;
sc_ClampUV(l9_67,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_66,l9_68);
l9_60=l9_68;
...
#endif
vec2 l9_69=sc_TransformUV(l9_59,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_70=l9_69.x;
float l9_71=l9_60;
sc_SoftwareWrapLate(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_71);
float l9_72=l9_69.y;
float l9_73=l9_71;
sc_SoftwareWrapLate(l9_72,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_73);
float l9_74=l9_73;
vec3 l9_75=sc_SamplingCoordsViewToGlobal(vec2(l9_70,l9_72),materialParamsTexLayout,l9_54);
vec4 l9_76=texture2D(materialParamsTex,l9_75.xy,0.0);
vec4 l9_77;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_77=mix(materialParamsTexBorderColor,l9_76,vec4(l9_74));
}
#else
{
l9_77=l9_76;
...
{
l9_78=mat3(l9_1,cross(l9_2,l9_1)*varTangent.w,l9_2)*((l9_53.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_78=vec3(0.0);
...
#endif
float l9_79=clamp(l9_29.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_79<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_79<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_80=max(l9_29.xyz,vec3(0.0));
vec4 l9_81;
#if (sc_ProjectiveShadowsCaster)
{
l9_81=vec4(l9_80,l9_79);
}
#else
{
float l9_82=clamp(l9_77.x,0.0,1.0);
float l9_83=clamp(l9_77.y,0.0,1.0);
vec3 l9_84=ssSRGB_to_Linear(l9_80);
vec3 l9_85=normalize(l9_78);
vec3 l9_86=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_87;
#if (sc_SSAOEnabled)
{
l9_87=evaluateSSAO(varPos);
}
#else
{
l9_87=clamp(vec3(l9_77.z),vec3(0.0),vec3(1.0));
}
#endif
vec3 l9_88=vec3(l9_82);
vec3 l9_89=mix(vec3(0.039999999),l9_84*l9_82,l9_88);
vec3 l9_90=mix(l9_84*(1.0-l9_82),vec3(0.0),l9_88);
SurfaceProperties l9_91=SurfaceProperties(l9_90,l9_79,l9_85,varPos,l9_0,l9_82,l9_83,l9_86,l9_87,Port_SpecularAO_N006,vec3(1.0),l9_89);
vec4 l9_92=vec4(1.0);
vec3 l9_93;
vec3 l9_94;
vec3 l9_95;
...
l9_101=vec3(0.0);
l9_100=vec3(0.0);
LightingComponents l9_107;
LightProperties l9_108;
SurfaceProperties l9_109;
vec3 l9_110;
int l9_111=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_111<sc_DirectionalLightsCount)
{
LightingComponents l9_112=accumulateLight(LightingComponents(l9_100,l9_101,l9_106,l9_105,l9_103,l9_102),LightProperties(sc_DirectionalLights[l9_111].direction,sc_DirectionalLights[l9_111].color.xyz,sc_DirectionalLights[l9_111].color.w*l9_92[(l9_104<3) ? l9_104 : 3]),l9_91,l9_0);
l9_106=l9_112.indirectDiffuse;
l9_105=l9_112.indirectSpecular;
l9_104++;
l9_103=l9_112.emitted;
l9_102=l9_112.transmitted;
l9_101=l9_112.directSpecular;
l9_100=l9_112.directDiffuse;
l9_111++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_129<sc_PointLightsCount)
{
vec3 l9_131=sc_PointLights[l9_129].position-varPos;
vec3 l9_132=normalize(l9_131);
float l9_133=l9_92[(l9_130<3) ? l9_130 : 3];
float l9_134=clamp((dot(l9_132,sc_PointLights[l9_129].direction)*sc_PointLights[l9_129].angleScale)+sc_PointLights[l9_129].angleOffset,0.0,1.0);
float l9_135=(sc_PointLights[l9_129].color.w*l9_133)*(l9_134*l9_134);
float l9_136;
if (sc_PointLights[l9_129].falloffEnabled)
{
l9_136=l9_135*computeDistanceAttenuation(length(l9_131),sc_PointLights[l9_129].falloffEndDistance);
}
else
{
l9_136=l9_135;
...
l9_122=l9_130+1;
LightingComponents l9_137=accumulateLight(LightingComponents(l9_116,l9_117,l9_121,l9_120,l9_119,l9_118),LightProperties(l9_132,sc_PointLights[l9_129].color.xyz,l9_136),l9_91,l9_0);
l9_123=l9_137.directDiffuse;
l9_124=l9_137.directSpecular;
l9_125=l9_137.indirectDiffuse;
l9_126=l9_137.indirectSpecular;
l9_127=l9_137.emitted;
l9_128=l9_137.transmitted;
l9_121=l9_125;
l9_120=l9_126;
l9_130=l9_122;
l9_119=l9_127;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_141=abs(varShadowTex-vec2(0.5));
vec4 l9_142=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_141.x,l9_141.y),0.5);
l9_140=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_142.xyz,vec3(sc_ShadowColor.w)),vec3(l9_142.w*sc_ShadowDensity));
}
#else
{
l9_140=vec3(1.0);
...
#endif
l9_139=l9_113*l9_140;
l9_138=l9_114*l9_140;
}
#else
{
l9_139=l9_113;
...
{
vec2 l9_144=calcPanoramicTexCoordsFromDir(l9_85,sc_EnvmapRotation.y);
vec4 l9_145;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_146=calcSeamlessPanoramicUvsForSampling(l9_144,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_146=l9_144;
...
#endif
l9_145=sc_EnvmapSpecularSampleViewIndexBias(l9_146,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_147;
...
{
vec2 l9_148=calcSeamlessPanoramicUvsForSampling(l9_144,sc_EnvmapDiffuseSize.xy,0.0);
int l9_149;
#if (sc_EnvmapDiffuseHasSwappedViews)
{
l9_149=1-sc_GetStereoViewIndex();
}
#else
{
l9_149=sc_GetStereoViewIndex();
}
#endif
l9_147=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_148,sc_EnvmapDiffuseLayout,l9_149).xy,-13.0);
}
#else
{
l9_147=sc_EnvmapSpecularSampleViewIndexBias(l9_144,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_145=l9_147;
}
#endif
l9_143=(l9_145.xyz*(1.0/l9_145.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_150;
...
float l9_154=l9_151.z;
l9_150=(((((((sc_Sh[8]*0.42904299)*((l9_152*l9_152)-(l9_153*l9_153)))+((sc_Sh[6]*0.74312502)*(l9_154*l9_154)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_152*l9_153))+(sc_Sh[7]*(l9_152*l9_154)))+(sc_Sh[5]*(l9_153*l9_154)))*0.85808599))+((((sc_Sh[3]*l9_152)+(sc_Sh[1]*l9_153))+(sc_Sh[2]*l9_154))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_150=vec3(0.0);
...
{
l9_156=l9_143+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_157=l9_143;
l9_157.x=l9_143.x+(1e-06*sc_AmbientLights[0].color.x);
l9_156=l9_157;
}
#endif
l9_155=l9_156;
...
{
l9_159=l9_155+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_160=l9_155;
l9_160.x=l9_155.x+(1e-06*sc_AmbientLights[1].color.x);
l9_159=l9_160;
}
#endif
l9_158=l9_159;
...
{
l9_162=l9_158+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_163=l9_158;
l9_163.x=l9_158.x+(1e-06*sc_AmbientLights[2].color.x);
l9_162=l9_163;
}
#endif
l9_161=l9_162;
...
{
vec3 l9_165;
l9_165=sc_LightEstimationData.ambientLight;
vec3 l9_166;
int l9_167=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_167<sc_LightEstimationSGCount)
{
float l9_168=dot(sc_LightEstimationData.sg[l9_167].axis,l9_85);
float l9_169=exp(-sc_LightEstimationData.sg[l9_167].sharpness);
float l9_170=l9_169*l9_169;
float l9_171=1.0/sc_LightEstimationData.sg[l9_167].sharpness;
float l9_172=(1.0+(2.0*l9_170))-l9_171;
float l9_173=sqrt(1.0-l9_172);
float l9_174=0.36000001*l9_168;
float l9_175=(1.0/(4.0*0.36000001))*l9_173;
float l9_176=l9_174+l9_175;
float l9_177;
if (step(abs(l9_174),l9_175)>0.5)
{
l9_177=(l9_176*l9_176)/l9_173;
}
else
{
l9_177=clamp(l9_168,0.0,1.0);
}
l9_166=l9_165+((((sc_LightEstimationData.sg[l9_167].color/vec3(sc_LightEstimationData.sg[l9_167].sharpness))*6.2831855)*((l9_172*l9_177)+(((l9_169-l9_170)*l9_171)-l9_170)))/vec3(3.1415927));
l9_165=l9_166;
l9_167++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_179=clamp(pow(l9_83,0.66666669),0.0,1.0)*5.0;
vec2 l9_180=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_85,reflect(-l9_0,l9_85),l9_83),sc_EnvmapRotation.y);
vec4 l9_181;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_182=floor(l9_179);
float l9_183=ceil(l9_179);
l9_181=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_180,sc_EnvmapSpecularSize.xy,l9_182),sc_EnvmapSpecularGetStereoViewIndex(),l9_182),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_180,sc_EnvmapSpecularSize.xy,l9_183),sc_EnvmapSpecularGetStereoViewIndex(),l9_183),vec4(l9_179-l9_182));
}
#else
{
l9_181=sc_EnvmapSpecularSampleViewIndexLevel(l9_180,sc_EnvmapSpecularGetStereoViewIndex(),l9_179);
}
#endif
l9_178=vec3(0.0)+((((l9_181.xyz*(1.0/l9_181.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_91,abs(dot(l9_85,l9_0))));
}
#else
{
l9_178=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_185=clamp(l9_83*l9_83,0.0099999998,1.0);
vec3 l9_186;
l9_186=sc_LightEstimationData.ambientLight*l9_89;
int l9_187=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_187<sc_LightEstimationSGCount)
{
float l9_188=l9_185*l9_185;
vec3 l9_189=reflect(-l9_0,l9_85);
float l9_190=dot(l9_85,l9_0);
float l9_191=(2.0/l9_188)/(4.0*max(l9_190,9.9999997e-05));
float l9_192=length((l9_189*l9_191)+(sc_LightEstimationData.sg[l9_187].axis*sc_LightEstimationData.sg[l9_187].sharpness));
float l9_193=clamp(dot(l9_85,l9_189),0.0,1.0);
float l9_194=clamp(l9_190,0.0,1.0);
float l9_195=1.0-l9_188;
l9_186+=((((((((vec3(1.0/(3.1415927*l9_188))*exp((l9_192-l9_191)-sc_LightEstimationData.sg[l9_187].sharpness))*sc_LightEstimationData.sg[l9_187].color)*6.2831855)*(1.0-exp((-2.0)*l9_192)))/vec3(l9_192))*((1.0/(l9_193+sqrt(l9_188+((l9_195*l9_193)*l9_193))))*(1.0/(l9_194+sqrt(l9_188+((l9_195*l9_194)*l9_194))))))*(l9_89+((vec3(1.0)-l9_89)*pow(1.0-clamp(dot(l9_189,normalize(l9_189+l9_0)),0.0,1.0),5.0))))*l9_193);
l9_187++;
continue;
}
else
...
l9_199=vec3(0.0);
l9_198=vec3(0.0);
l9_197=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_90,vec3(l9_79));
l9_196=1.0;
}
#else
{
...
#endif
vec3 l9_201=l9_198*l9_87;
vec3 l9_202=l9_199+l9_201;
vec3 l9_203=l9_90*l9_202;
vec3 l9_204=l9_184*Port_SpecularAO_N006;
vec3 l9_205=l9_138+l9_204;
vec3 l9_206;
if (l9_200)
{
l9_206=l9_203*srgbToLinear(l9_196);
}
else
{
l9_206=l9_203;
}
vec3 l9_207=l9_206+l9_205;
vec3 l9_208=(l9_207+l9_86)+l9_197;
float l9_209=l9_208.x;
vec4 l9_210=vec4(l9_209,l9_208.yz,l9_196);
vec4 l9_211;
#if (sc_IsEditor)
{
vec4 l9_212=l9_210;
l9_212.x=l9_209+((l9_87.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_211=l9_212;
}
#else
{
...
{
vec3 l9_214=l9_211.xyz*1.8;
vec3 l9_215=(l9_211.xyz*(l9_214+vec3(1.4)))/((l9_211.xyz*(l9_214+vec3(0.5)))+vec3(1.5));
l9_213=vec4(l9_215.x,l9_215.y,l9_215.z,l9_211.w);
}
#else
{
l9_213=l9_211;
...
#endif
vec3 l9_216=vec3(linearToSrgb(l9_213.x),linearToSrgb(l9_213.y),linearToSrgb(l9_213.z));
l9_81=vec4(l9_216.x,l9_216.y,l9_216.z,l9_213.w);
}
#endif
vec4 l9_217=max(l9_81,vec4(0.0));
vec4 l9_218;
#if (sc_ProjectiveShadowsCaster)
{
float l9_219;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_220=clamp(l9_217.w*2.0,0.0,1.0);
}
#else
{
float l9_221;
...
{
l9_221=clamp(dot(l9_217.xyz,vec3(l9_217.w)),0.0,1.0);
}
#else
{
float l9_222;
...
#if (sc_BlendMode_Multiply)
{
l9_223=(1.0-dot(l9_217.xyz,vec3(0.33333001)))*l9_217.w;
}
#else
{
float l9_224;
...
{
l9_224=(1.0-clamp(dot(l9_217.xyz,vec3(1.0)),0.0,1.0))*l9_217.w;
}
#else
{
float l9_225;
#if (sc_BlendMode_ColoredGlass)
{
l9_225=clamp(dot(l9_217.xyz,vec3(1.0)),0.0,1.0)*l9_217.w;
}
#else
{
float l9_226;
#if (sc_BlendMode_Add)
{
l9_226=clamp(dot(l9_217.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_227;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_227=clamp(dot(l9_217.xyz,vec3(1.0)),0.0,1.0)*l9_217.w;
}
#else
{
float l9_228;
...
{
l9_228=dot(l9_217.xyz,vec3(0.33333001))*l9_217.w;
}
#else
{
float l9_229;
#if (sc_BlendMode_Min)
{
l9_229=1.0-clamp(dot(l9_217.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_230;
#if (sc_BlendMode_Max)
{
l9_230=clamp(dot(l9_217.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_230=1.0;
...
#endif
l9_218=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_217.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_219);
}
#else
{
vec4 l9_231;
...
{
vec3 l9_233=sc_GetFramebufferColor().xyz;
vec3 l9_234=mix(l9_233,definedBlend(l9_233,l9_217.xyz).xyz,vec3(l9_217.w));
vec4 l9_235=vec4(l9_234.x,l9_234.y,l9_234.z,vec4(0.0).w);
l9_235.w=1.0;
l9_232=l9_235;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_237=l9_217.w;
l9_236=vec4(mix(vec3(1.0),l9_217.xyz,vec3(l9_237)),l9_237);
}
#else
{
vec4 l9_238;
...
{
float l9_239=l9_217.w;
float l9_240;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_240=clamp(l9_239,0.0,1.0);
}
#else
{
l9_240=l9_239;
...
#endif
l9_238=vec4(l9_217.xyz*l9_240,l9_240);
}
#else
{
l9_238=l9_217;
...
{
l9_243=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_243=vec4(0.0);
...
vec4 l9_245=outputMotionVectorsIfNeeded(varPos,max(l9_244,vec4(0.0)));
vec4 l9_246=clamp(l9_245,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_247=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_247-0.0039215689)),min(1.0,l9_247+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_248=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_248).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_249=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_248).xy);
float l9_250=packValue(l9_249);
int l9_257=int(l9_246.w*255.0);
float l9_258=packValue(l9_257);
sc_writeFragData0(vec4(packValue(l9_249),packValue(l9_249),packValue(l9_249),packValue(l9_249)));
sc_writeFragData1(vec4(l9_250,packValue(l9_249),packValue(l9_249),packValue(l9_249)));
sc_writeFragData2(vec4(l9_258,packValue(l9_257),packValue(l9_257),packValue(l9_257)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_261).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_266==0)
{
l9_269=texture2D(sc_OITAlpha0,l9_261);
l9_268=texture2D(sc_OITDepthLow0,l9_261);
l9_267=texture2D(sc_OITDepthHigh0,l9_261);
}
else
{
l9_269=vec4(0.0);
...
if (l9_266==1)
{
l9_272=texture2D(sc_OITAlpha1,l9_261);
l9_271=texture2D(sc_OITDepthLow1,l9_261);
l9_270=texture2D(sc_OITDepthHigh1,l9_261);
}
else
{
l9_272=l9_269;
...
if (any(notEqual(l9_270,vec4(0.0)))||any(notEqual(l9_271,vec4(0.0))))
{
int l9_273[8]=l9_262;
unpackValues(l9_270.w,l9_266,l9_273);
unpackValues(l9_270.z,l9_266,l9_273);
unpackValues(l9_270.y,l9_266,l9_273);
unpackValues(l9_270.x,l9_266,l9_273);
unpackValues(l9_271.w,l9_266,l9_273);
unpackValues(l9_271.z,l9_266,l9_273);
unpackValues(l9_271.y,l9_266,l9_273);
unpackValues(l9_271.x,l9_266,l9_273);
int l9_282[8]=l9_263;
unpackValues(l9_272.w,l9_266,l9_282);
unpackValues(l9_272.z,l9_266,l9_282);
unpackValues(l9_272.y,l9_266,l9_282);
unpackValues(l9_272.x,l9_266,l9_282);
}
l9_266++;
continue;
}
...
vec4 l9_287=texture2D(sc_OITFilteredDepthBoundsTexture,l9_261);
vec2 l9_288=l9_287.xy;
int l9_289;
#if (sc_SkinBonesCount>0)
{
l9_289=encodeDepth(((1.0-l9_287.x)*1000.0)+getDepthOrderingEpsilon(),l9_288);
}
#else
{
l9_289=0;
...
#endif
int l9_290=encodeDepth(viewSpaceDepth(),l9_288);
vec4 l9_291;
l9_291=l9_246*l9_246.w;
vec4 l9_292;
int l9_293=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_293<8)
{
int l9_294=l9_262[l9_293];
int l9_295=l9_290-l9_289;
bool l9_296=l9_294<l9_295;
bool l9_297;
if (l9_296)
{
l9_297=l9_262[l9_293]>0;
}
else
{
l9_297=l9_296;
...
if (l9_297)
{
vec3 l9_298=l9_291.xyz*(1.0-(float(l9_263[l9_293])/255.0));
l9_292=vec4(l9_298.x,l9_298.y,l9_298.z,l9_291.w);
}
else
{
l9_292=l9_291;
